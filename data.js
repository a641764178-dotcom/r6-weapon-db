...
// r6operators CDN 未收录的干员 → 站内本地图标
// Solid Snake: Liquipedia Commons「R6S Solid Snake Operator Icon.png」(1000x1000 PNG)
const OPERATOR_LOCAL_ICON = {
    'Solid Snake': 'images/operators/solid-snake.png'
};

// 获取干员图标URL，没有图标的返回null
function getOperatorIconURL(name) {
    if (OPERATOR_LOCAL_ICON[name]) return OPERATOR_LOCAL_ICON[name];
...
// ================================================================
const OPERATORS = [
    { name: 'Ace', side: 'atk', icon: 'ace.svg', portrait: 'images/operators/ace.webp', gadgetIcon: 'images/gadgets/ace.webp', gadgetIconName: 'Ace S.E.L.M.A. Aqua Breacher', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Breach', 'Anti-Gadget'], realname: 'Håvard Haugland', birthplace: 'Lærdalsøyri', birthdate: '1987-3-15', affiliation: 'NIGHTHAVEN', country: [], releasedate: '2020-06-16', gadget: 'S.E.L.M.A. Aqua Breacher', gadget_desc: 'With the S.E.L.M.A. Aqua Breacher, water is the name of the game. It makes use of hydraulic pressure to burst through breakable and reinforced surfaces.', gadget_zh: null, gadget_zh_desc: '可投掷式设备，能部署液压弹丸，爆破可破坏以及加固的表面。', gadget_stats: ['持有数量：3', '引爆所需时间：4s/每个液压弹丸', '无冷却时间', '初始数量为3，每隔60秒额外获得一次。', '最大可携带数量：3', '最大可部署数量：3', '点击即可投出使用。', '或者按住取出，在松开时投出。'], weapons: ['AK-12', 'M1014', 'P9'] },
    { name: 'Alibi', side: 'def', icon: 'alibi.svg', portrait: 'images/operators/alibi.webp', gadgetIcon: null, gadgetIconName: null, armor: '1', speed: 'fast', difficulty: 'hard', function: ['Intel', 'Trapper'], realname: 'Aria de Luca', birthplace: 'Tripoli', birthdate: '1980-12-15', affiliation: 'G.I.S', country: ['it'], releasedate: '2018-06-07', gadget: 'Prisma', gadget_desc: 'Prisma projects holograms are nearly identical to Alibi in an idle position. If you shoot or touch the holograms, you’ll be marked and pinged for the next few seconds. If Prisma is deployed outside, a false “Defender Outside” warning is triggered for Attackers. To add an element of surprise, Prisma conceals the identity of any Defender who ventures outside.', gadget_zh: null, gadget_zh_desc: '俗称：棱镜、投影、幻象', gadget_stats: ['持有数：3', '初始数量为3，每隔90秒额外获得一次。', '最大可携带数量：3', '最大可部署数量：3', '当Alibi在回合中出场时，防守方因走出建筑物而被暴露位置后不会显示出干员身份。棱镜在室外生成的投影不再会被暴露。', '*投影的标记次数为5次，每次持续1秒', '*被任何物体穿过的全息投影会闪烁或消失，并且会出现光。', '装置并不是在任何情况下都能正确部署：'], weapons: ['ACS12', 'Bailiff 410', 'Keratos .357', 'Mx4 Storm'] },
    { name: 'Amaru', side: 'atk', icon: 'amaru.svg', portrait: 'images/operators/amaru.webp', gadgetIcon: 'images/gadgets/amaru.webp', gadgetIconName: 'Amaru Garra Hook', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Front Line', 'Map Control'], realname: 'Azucena Rocío Quispe', birthplace: 'Cojata', birthdate: '1971-05-06', affiliation: 'APCA', country: ['pe'], releasedate: '2019-09-11', gadget: 'Garra Hook', gadget_desc: 'With the Garra Hook, Amaru can grapple onto ledges and windows and hoist herself up in record times. Her opponents now not only have to worry about attacks from above, but also attacks from below. With the Garra, Amaru is the only operator that can go up an unreinforced or open hatch, instead of down. When timed right, hooking the Garra onto a window can result in Amaru’s infamous Garra Kick, which instantly takes out an opponent standing behind the window.', gadget_zh: null, gadget_zh_desc: '一把拉伸强度较高的爪钩枪，能让人快速移动到绳降点和活板门，或从外墙窗户进入建筑，但拉伸距离有限。', gadget_stats: ['使用次数：5', '冷却时间：8秒', '初始数量为4，每隔45秒额外获得一次。', '最大可携带数量：4', '发射后滑行速度：最高9米/秒', '爪钩枪的发射条件：', '* 允许发射范围：5米-15米；', '* 目标为窗户时，角色必须位于建筑外部，发射点所处边缘的垂线与人物所在位置的夹角不超过60°；'], weapons: ['G8A1', 'GONNE-6', 'ITA12S', 'SMG-11', 'SuperNova'] },
    { name: 'Aruni', side: 'def', icon: 'aruni.svg', portrait: 'images/operators/aruni.webp', gadgetIcon: 'images/gadgets/aruni.webp', gadgetIconName: 'Aruni Surya Gate', armor: '3', speed: 'slow', difficulty: 'normal', function: ['Anti-Entry', 'Anti-Gadget'], realname: 'Apha Tawanroong', birthplace: 'Ta Phraya District', birthdate: '1978-08-09', affiliation: 'NIGHTHAVEN', country: [], releasedate: '2020-12-01', gadget: 'Prosthetic Arm', gadget_desc: 'Melee punch with destructive capabilities.', gadget_zh: null, gadget_zh_desc: '可固定在墙体或攻入点上的激光发射装置，在对装备或敌人造成伤害后会停用，可以重新启用', gadget_stats: ['持有数量：3', '对干员伤害：30HP/次', '过载后冷却时间：30s', '重启次数限制：无限次', '对着可部署的表面长按施放。', '在激光门本体附近面朝本体，长按可以收回技能道具。', '将视角对准门、窗、活板门和可完全破坏的墙面部署激光门发生器，之后在部署位置生成激光门。', '炎阳激光门生成在门上的时候，会和封阻物一样，下方会留有供侦察无人机穿行的缝隙。'], weapons: ['Mk 14 EBR', 'P10 RONI', 'PRB92'] },
    { name: 'Ash', side: 'atk', icon: 'ash.svg', portrait: 'images/operators/ash.webp', gadgetIcon: 'images/gadgets/ash.webp', gadgetIconName: 'M120 CREM', armor: '1', speed: 'fast', difficulty: 'normal', function: ['Breach', 'Front Line'], realname: 'Eliza Cohen', birthplace: 'Jerusalem', birthdate: '1983-12-24', affiliation: 'SWAT', country: ['us'], releasedate: '2015-12-01', gadget: 'M120 CREM (Breaching Round)', gadget_desc: 'Modified grenade launcher capable of containing a single 40mm breaching round. Detonating shortly after impact.', gadget_zh: '爆破弹', gadget_zh_desc: '发射一枚爆破弹穿透目标表面并自动引爆。', gadget_stats: ['可使用次数：2', '单发伤害：50', '爆炸范围：2.2m', '榴弹发射后会自动手动填装。', '发射后的爆破弹会镶嵌在任意物体表面，并在1.5秒后自动爆炸。', '爆破弹如果击中可破坏表面，爆炸后会造成一个大面积洞口。', '爆破弹造成的破坏效果可以无视击中位置破坏未加固活板门。也就是说，只要爆炸效果能波及活板门，击中附近的墙面或地面也可以破坏未加固活板门。', '爆破弹爆炸时会摧毁范围内几乎所有的设备。'], weapons: ['5.7 USG', 'G36C', 'M45 MEUSOC', 'R4-C'] },
    { name: 'Azami', side: 'def', icon: 'azami.svg', portrait: 'images/operators/azami.webp', gadgetIcon: 'images/gadgets/azami.webp', gadgetIconName: 'Kiba Barrier', armor: '2', speed: 'medium', difficulty: 'hard', function: ['Anti-Entry', 'Support'], realname: 'Kana Fujiwara', birthplace: 'Kyoto, Japan', birthdate: '1993-09-06', affiliation: null, country: [], releasedate: '2022-03-15', gadget: 'Kiba Barrier', gadget_desc: 'The Kiba Barrier is a modified kunai that sticks to a surface after it\'s thrown and releases a material that first expands then solidifies, creating a bulletproof barrier to patch up those holes in your defenses.', gadget_zh: null, gadget_zh_desc: '可投掷式装备，能附着于表面，随后释放的气体将凝固形成防弹屏障。', gadget_stats: ['别称：苦无', '道具数量：1+4个', '生成所需时间：30秒/个', '掩体范围：直径为2米的圆形。', '初始数量为2，每隔50秒额外获得一次。', '最大可携带数量：2', '最大可部署数量：2', '按下拿出，松开后向任何想要的墙体或地面投掷。'], weapons: ['9x19VSN', 'ACS12', 'D-50'] },
    { name: 'Bandit', side: 'def', icon: 'bandit.svg', portrait: 'images/operators/bandit.webp', gadgetIcon: 'images/gadgets/bandit.webp', gadgetIconName: 'CED-1 (Crude Electrical Device)', armor: '1', speed: 'fast', difficulty: 'easy', function: ['Anti-Entry', 'Anti-Gadget'], realname: 'Dominic Brunsmeier', birthplace: 'Berlin', birthdate: '1974-08-13', affiliation: 'GSG 9', country: ['de'], releasedate: '2015-12-01', gadget: 'CED-1 (Crude Electrical Device)', gadget_desc: 'The CED-1 features an taser wired to a car battery enclosed in a copper cage with jumper cables. It\'s defensive purpose is to destroy any gadget it comes in contact with making it a viable counter to exo-thermic charges and X-KAIROS pallets. Placeable on any metallic surface, it can protect barbed wire, deployable shields, and reinforced walls.', gadget_zh: null, gadget_zh_desc: '设置一个可将其他装备通电的简易充电设备，并且对任何接触到的物体造成电击伤害。', gadget_stats: ['道具数量：4个', '部署所需时间：2.5秒', '初始数量为4，每隔60秒额外获得一次。', '最大可携带数量：4', '最大可部署数量：4', '可以通电的防守方物品包括但不限于：', '* 加固墙；', '* 倒刺铁丝网；'], weapons: ['Keratos .357', 'M870', 'MP7', 'P12'] },
    { name: 'Blackbeard', side: 'atk', icon: 'blackbeard.svg', portrait: 'images/operators/blackbeard.webp', gadgetIcon: null, gadgetIconName: null, armor: '3', speed: 'slow', difficulty: 'normal', function: ['Breach', 'Front Line'], realname: 'Craig Jenson', birthplace: 'Bellevue', birthdate: '1985-03-12', affiliation: 'NAVY SEAL', country: ['us'], releasedate: '2016-05-10', gadget: 'H.U.L.L. Adaptable Shield', gadget_desc: 'The shield is capable of adapting its shape to grant the best cover while on foot and in rappel. The shield also includes a breaching pneumatic system that allows Blackbeard to create his own rotations by destroy soft walls. Blackbeard\'s weapon skills allow him to simultaneously equip the H.U.L.L. Adaptable Shield and primary weapons.', gadget_zh: null, gadget_zh_desc: '防弹护盾，能冲破可破坏的防线，绳降时也能折叠使用。', gadget_stats: ['冲撞使用次数：3', '冷却时间：8秒', '冲撞伤害：20HP', '单击使用冲撞；', '游戏开始时默认手持护盾，按下或滚动可以在手持和把护盾背在身后之间切换。', 'H.U.L.L.自适应护盾的上半部分（即观察窗）为一块完整的透明防弹玻璃，不会被近战攻击敲碎；下半部分为三块可折叠收缩的不透明防弹护盾，构造类似机动护盾。', '干员进行开镜瞄准时，盾牌观察窗会将防弹玻璃向下滑动，整块防弹玻璃会折叠到护盾的中间部分区域。', '在进行绳降时，自适应护盾的两块下半盾牌会往上折叠，只留下一块上部盾牌和防弹玻璃提供防护，为干员腿部提供活动空间，同时也无法保护干员腿部。'], weapons: ['D-50', 'Mk17 CQB', 'SR-25'] },
    { name: 'Blitz', side: 'atk', icon: 'blitz.svg', portrait: 'images/operators/blitz.webp', gadgetIcon: 'images/gadgets/blitz.webp', gadgetIconName: 'G52-Tactical Shield', armor: '2', speed: 'medium', difficulty: 'hard', function: ['Front Line', 'Map Control'], realname: 'Elias Kötz', birthplace: 'Bremen', birthdate: '1980-04-02', affiliation: 'GSG 9', country: ['de'], releasedate: '2015-12-01', gadget: 'G52-Tactical Shield', gadget_desc: 'Ballistic shield light enough to permit its wielder to sprint, it comes equipped with 24 flash-bang grenades spread over 3 rows providing a high intensity light source when triggered.', gadget_zh: null, gadget_zh_desc: '启用装配在防弹盾牌上的高亮闪光灯来暂时让敌人眩盲。', gadget_stats: ['使用次数：4', '冷却时间：7秒', '致盲范围：5米', '单击使用闪光灯；', '游戏开始时默认手持闪光护盾，按下或滚动可以在手持和把闪光护盾背在身后之间切换；', '护盾背在身后时单击会切换至手持并使用闪光灯。', '闪光灯可对前方水平角度至少60度，距离2个身位内的敌人产生作用。', '闪光灯效果不同于闪光弹，可以致盲但不会使目标失去听觉。'], weapons: ['P12'] },
    { name: 'Brava', side: 'atk', icon: 'brava.svg', portrait: 'images/operators/brava.webp', gadgetIcon: 'images/gadgets/brava.webp', gadgetIconName: 'Kludge Drone', armor: '1', speed: 'fast', difficulty: 'hard', function: ['Intel', 'Anti-Gadget'], realname: 'Nayara Cardoso', birthplace: 'Curitiba, Brazil', birthdate: '1983-01-10', affiliation: 'COT', country: [], releasedate: '2023-03-07', gadget: 'Kludge Drone', gadget_desc: 'Brava\'s Kludge Drone is a sabotage tool capable of taking over opponents\' devices. If the device can\'t be controlled, it\'s destroyed instead.', gadget_zh: null, gadget_zh_desc: '可部署的无人机，可以控制电子设备，或在短暂延迟后将其摧毁。', gadget_stats: ['持有数量：2辆', '激光弹药数量：无限', '黑入设备数量限制：3个/辆', '黑入距离：10米', '射击间隔：1秒', '黑入所需时间：2秒', '巧集无人机外部的发射管会跟随无人机操控者视角的高度升降，但不会影响无人机实际碰撞体积。', '巧集无人机有着独特的HUD界面：'], weapons: ['CAMRS', 'PARA-308', 'Super Shorty', 'USP40'] },
    { name: 'Buck', side: 'atk', icon: 'buck.svg', portrait: 'images/operators/buck.webp', gadgetIcon: 'images/gadgets/buck.webp', gadgetIconName: 'SK 4-12', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Breach', 'Support'], realname: 'Sebastien Côté', birthplace: 'Montreal', birthdate: '1980-08-20', affiliation: 'JTF2', country: ['ca'], releasedate: '2016-02-02', gadget: 'SK 4-12 (Skeleton Key)', gadget_desc: 'Under-barrel mounted 12 gauge shotgun with four round capacity, used in tandem with an assault rifle. The Skeleton Key allows the operator to alternate between their standard issue assault rifle and a breaching shotgun with ease and efficiency.', gadget_zh: null, gadget_zh_desc: 'MASS下挂霰弹枪|缩略图|260px', gadget_stats: ['可使用次数:31', '弹容:5+1', '初始数量为31，每隔30秒额外获得5次。', '最大可携带数量：31', '单击可以在主武器模式和下挂式霰弹枪模式之间切换', '点击可以开火射击', '“万能钥匙”为半自动下挂式霰弹枪。供弹方式为弹匣供弹，可进行战术换弹；', '与普通霰弹枪有同样的机制，开镜瞄准可以缩小弹丸扩散区域；'], weapons: ['C8-SFW', 'CAMRS', 'Mk1 9mm'] },
    { name: 'Capitão', side: 'atk', icon: 'capitao.svg', portrait: 'images/operators/capitao.webp', gadgetIcon: 'images/gadgets/capitao.webp', gadgetIconName: 'TAC MK0', armor: '1', speed: 'fast', difficulty: 'normal', function: ['Front Line', 'Map Control'], realname: 'Vicente Souza', birthplace: 'Nova Iguaçu', birthdate: '1967-11-17', affiliation: 'BOPE', country: ['br'], releasedate: '2016-08-02', gadget: 'TAC MK0 Tactical Crossbow', gadget_desc: 'Use a glass bolt to deliver a swift and silent assault against hostiles without alerting them to your position. The glass cartridge breaks on impact releasing a gas that ignites the oxygen in the surrounding area. Deliver swift and agile assaults without alerting your opponents of your position.', gadget_zh: null, gadget_zh_desc: null, gadget_stats: [], weapons: ['M249', 'PARA-308', 'PMR90A2', 'PRB92'] },
    { name: 'Castle', side: 'def', icon: 'castle.svg', portrait: 'images/operators/castle.webp', gadgetIcon: 'images/gadgets/castle.webp', gadgetIconName: 'Armor Panel', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Anti-Entry', 'Support'], realname: 'Miles Campbell', birthplace: 'Los Angeles, California', birthdate: '1980-09-20', affiliation: 'SWAT', country: ['us'], releasedate: '2015-12-01', gadget: 'UTP1-Universal Tactical Panel', gadget_desc: 'Rollable armor panel made of Polyethylene, ballistic fabric, and boron ceramic micro plates.', gadget_zh: '装甲板', gadget_zh_desc: '装设抗性强于一般封阻物的防弹装甲版。', gadget_stats: ['数量：4', '布设时间：3.5秒', '防守方拆除所需时间：2秒', '可承受的近战攻击次数：9次', '装甲板的面积与普通封阻物大小一样，会根据安装的门/窗户的大小变化。', '安装后的装甲板无法被任何子弹贯穿，并且会削减爆炸物所导致的一部分伤害。', '安装后的装甲板会被和贯穿，并留下一个可以用于观察和射击的真正小洞。', '装甲板可以被通电，无法被通电。'], weapons: ['5.7 USG', 'M1014', 'M45 MEUSOC', 'Super Shorty', 'UMP45'] },
    { name: 'Caveira', side: 'def', icon: 'caveira.svg', portrait: 'images/operators/caveira.webp', gadgetIcon: 'images/gadgets/caveira.webp', gadgetIconName: 'Luison', armor: '1', speed: 'fast', difficulty: 'hard', function: ['Intel', 'Crowd Control'], realname: 'Taina Pereira', birthplace: 'Rinópolis', birthdate: '1989-10-15', affiliation: 'BOPE', country: ['br'], releasedate: '2016-08-02', gadget: 'Silent Step', gadget_desc: 'Caveira\'s predatory stealth, the "Silent Step," allows her to lurk on her prey, leaving no footprints and almost inaudible, until it\'s too late.', gadget_zh: null, gadget_zh_desc: null, gadget_stats: [], weapons: ['Luison', 'M12', 'PRB92', 'SPAS-15'] },
    { name: 'Clash', side: 'def', icon: 'clash.svg', portrait: 'images/operators/clash.webp', gadgetIcon: null, gadgetIconName: null, armor: '3', speed: 'slow', difficulty: 'hard', function: ['Intel', 'Crowd Control'], realname: 'Morowa Evans', birthplace: 'London', birthdate: '1983-06-07', affiliation: 'MPS GSUTR', country: ['uk'], releasedate: '2018-09-04', gadget: 'CCE Shield', gadget_desc: 'The CCE Shield is her primary weapon; she can swap to her secondary at any time, but to do so, she needs to put her shield away first. Her bulletproof extendable shield has the ability to slow down opponents by using a high voltage Charged Field Generator (CFG) that emanates directly in front of the shield in a cylindrical shape. Opponents caught in the CFG also sustain low damage over time. Effective use of the shield allows Clash to block entry points, and to prevent or delay a push by the Attackers.', gadget_zh: null, gadget_zh_desc: '能够减缓敌人速度的伸缩电力护盾。', gadget_stats: ['最长连续释放电击时间：15秒', '最大充能时间：15秒', '完全消耗冷却：4秒', '充能延时：1秒', '伤害范围：同一高度下，前方约120°的所有进攻方', '最远伤害距离：12米', '游戏开始时默认持枪，按下、或滚动能够在持盾和持枪两个状态间切换。', '手持盾牌时，按住可以将盾牌以完全展开的方式部署在地面。'], weapons: ['P-10C', 'SPSMG9', 'Super Shorty'] },
    { name: 'Deimos', side: 'atk', icon: 'deimos.svg', portrait: 'images/operators/deimos.webp', gadgetIcon: 'images/gadgets/deimos.webp', gadgetIconName: 'DeathMark Tracker', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Intel', 'Map Control'], realname: 'Gerald Morris', birthplace: 'Birmingham, Alabama', birthdate: '1972-12-24', affiliation: null, country: [], releasedate: '2024-02-24', gadget: 'DeathMark Tracker', gadget_desc: 'The miniature flying probe seeks out a chosen target and reveals their location to Deimos while also revealing his location. with his custom .44 Vendetta being the only weapon available while tracking, Deimos makes it personal.', gadget_zh: null, gadget_zh_desc: '小型探测器，可能让一名敌方和Deimos之间在限定时间内相互暴露。', gadget_stats: ['装置数量：0+3个', '生成所需时间：20秒/个', '技能冷却：10秒', '技能使用读条：2秒', '警告持续时间：4秒', '追踪标记时间：15秒', '在扫描前可以按切换扫描的目标；', '按住可对选定的目标放出探测器。'], weapons: ['.44 Vendetta', 'AK-74M', 'M590A1'] },
    { name: 'Denari', side: 'def', icon: 'denari.svg', portrait: 'images/operators/denari.webp', gadgetIcon: 'images/gadgets/denari.webp', gadgetIconName: 'T.R.I.P Connector', armor: '1', speed: 'fast', difficulty: 'hard', function: ['Anti-Entry', 'Crowd Control'], realname: 'Leon Winzenried', birthplace: 'Lugano', birthdate: '1986-11-30', affiliation: null, country: [], releasedate: '2025-09-02', gadget: 'T.R.I.P Connector', gadget_desc: 'Cover an entire room with Denari\'s unique ability, the T.R.I.P. Connector. When two devices are deployed within line of sight of each other, a laser connects between them. Once tripped, the laser will slow and injure enemies. Deploying more devices will create a larger web of lasers, creating an area of denial to best fit defensive needs for any room.', gadget_zh: '投掷物预测线', gadget_zh_desc: '简称：链光器、拌线', gadget_stats: ['持有数量：7个', '最大连接距离：20米', '激光恢复时间：8秒', '单根激光伤害：20', '干员减速时长：8秒', '按下拿出链光器，按下以投掷。', '按住即可拿出链光器并准备投掷，松开即可投掷。', '链光器的体积很小，投掷时可以穿过楼层间的钢筋，甚至可以吸附在钢筋上。'], weapons: ['FMG-9', 'Glaive-12', 'P226 MK 25', 'Scorpion EVO'] },
    { name: 'Doc', side: 'def', icon: 'doc.svg', portrait: 'images/operators/doc.webp', gadgetIcon: 'images/gadgets/doc.webp', gadgetIconName: 'MPD-0 Stim Pistol', armor: '3', speed: 'slow', difficulty: 'easy', function: ['Support'], realname: 'Gustave Kateb', birthplace: 'Paris', birthdate: '1977-09-16', affiliation: 'GIGN', country: ['fr'], releasedate: '2015-12-01', gadget: 'MPD-0 Stim Pistol', gadget_desc: 'Handheld, trigger operated pistol powered by a pressurized CO2 canister. Contains a 1mg dose of epinephrine, in a saline solution.', gadget_zh: null, gadget_zh_desc: '从远距离发射药物注射器来治疗自己或队友。也能提供短时的超额治疗。', gadget_stats: ['使用次数：3', '冷却时间：无', '生命值回复量：200/次', '手持激素手枪时，点击发射激素', '手持激素手枪时，也可以再次按下对自己进行治疗', '激素手枪最多只能载弹1发，发射后须要再次装填才能继续发射。装填时间为2秒。', '激素手枪可以治疗射中的任何人，包括人质。但对任何装置和身为机器人的无效。', '激素手枪在治疗时会造成超出干员生命值上限的过量治疗，超出部分的生命值会转变为。会以1点/秒的速度消减。'], weapons: ['Bailiff 410', 'LFP586', 'MP5', 'P9', 'P90', 'SG-CQB'] },
    { name: 'Dokkaebi', side: 'atk', icon: 'dokkaebi.svg', portrait: 'images/operators/dokkaebi.webp', gadgetIcon: 'images/gadgets/dokkaebi.webp', gadgetIconName: 'Logic Bomb', armor: '1', speed: 'fast', difficulty: 'normal', function: ['Intel', 'Map Control'], realname: 'Grace Nam', birthplace: 'Seoul', birthdate: '1988-2-2', affiliation: '707th SMB', country: ['kr'], releasedate: '2017-12-05', gadget: 'Logic Bomb', gadget_desc: 'Grace utilizes the Ballistic Armor Military Laptop, codenamed Logic Bomb, which she uses to hack enemy PDA tactical devices. The program downloads a virus of her making that can bypass firewalls, turning surrounding devices on and emitting a loud noise to compromise an enemy’s position.', gadget_zh: null, gadget_zh_desc: '向敌方设备传输恶意软件，禁用其访问观测工具的权限。受影响的设备随后会爆炸。', gadget_stats: ['使用次数：1+4次', '单次充能时间：25秒/次', '持续时间：7秒', '冷却时间：14秒（每个目标单独计算）', '手机爆炸伤害：40点', '手机爆炸火焰：5秒', '按选择要释放的对象。', '按住1.3秒后施放完成。'], weapons: ['BOSG.12.2', 'C75 Auto', 'GONNE-6', 'Mk 14 EBR', 'SMG-12', 'XK23'] },
    { name: 'Echo', side: 'def', icon: 'echo.svg', portrait: 'images/operators/echo.webp', gadgetIcon: 'images/gadgets/echo.webp', gadgetIconName: 'Yokai Drone', armor: '3', speed: 'slow', difficulty: 'hard', function: ['Intel', 'Crowd Control'], realname: 'Masaru Enatsu', birthplace: 'Suginami', birthdate: '1980-10-31', affiliation: 'S.A.T.', country: ['jp'], releasedate: '2016-11-17', gadget: 'YOKAI (Unmanned hovering vehicle)', gadget_desc: 'Equipped with an acoustic hailing device, this signature drone can fire ultrasonic bursts that disorient all targets in a given perimeter. Yokai also transmits a video feed to Echo, who keeps his immediate perimeter secure. Embrace the power of technology and embody a turret Defender who can both hold up the siege and support roamers.', gadget_zh: null, gadget_zh_desc: '俗称：妖怪、（小）飞机', gadget_stats: ['数量：3', '弹药数：2/∞/每台', '充能时间：15秒/发', '声波冲击射程：13米', '按下来扔出一台妖怪，也可以按住按键握持在手上，松开按键抛出。', '在观测工具界面下可以直接切换到的界面。', '*按下可以在的悬挂和下降到地面两个状态间切换，瞄准后按下可以震撼目标区域内的人。其余操作与普通的无人侦察机无异，相关内容请参阅观测工具操控。', '在身上没有携带的时候，按下可以直接进入其中一台的观测界面。或者按进入观测工具界面后用和或者和来切换。'], weapons: ['Bearing 9', 'MP5SD', 'P229', 'SuperNova'] },
    { name: 'Ela', side: 'def', icon: 'ela.svg', portrait: 'images/operators/ela.webp', gadgetIcon: 'images/gadgets/ela.webp', gadgetIconName: 'Grzmot Mine', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Trapper', 'Crowd Control'], realname: 'Elżbieta Bosak', birthplace: 'Wrocław', birthdate: '1985-11-08', affiliation: 'GROM', country: ['pl'], releasedate: null, gadget: 'Grzmot Mine', gadget_desc: 'Inspired by the 1939 anti-tank Polish grenades used by the iconic Cichociemny during WWII, the sticky Grzmot mines can be anchored on surfaces, impairing hearing and causing a dizzying effect. These concussion mines are triggered upon proximity, affecting anyone within its radius.', gadget_zh: null, gadget_zh_desc: '俗称：ELA棒、冰淇淋', gadget_stats: ['数量：3', '雷鸣地雷触发范围：4米', '雷鸣地雷作用范围：4米', '雷鸣地雷震撼效果时长：9秒', '按住即可取出雷鸣地雷以准备投掷，松开即可投出。', '对于已部署的雷鸣地雷，站在它旁边，对其按住即可收回。', '雷鸣地雷投掷后可黏附在任何表面，并在1秒后处于部署状态，指示灯将亮起。', '当进攻方进入触发范围内后将引爆，产生巨响的同时并对作用范围内所有干员产生以下不同的减益效果：'], weapons: ['FO-12', 'RG15', 'Scorpion EVO'] },
    { name: 'Fenrir', side: 'def', icon: 'fenrir.svg', portrait: 'images/operators/fenrir.webp', gadgetIcon: 'images/gadgets/fenrir.webp', gadgetIconName: 'F-NATT DREAD MINE', armor: '2', speed: 'medium', difficulty: 'hard', function: ['Trapper', 'Crowd Control'], realname: 'Emil Svensson', birthplace: 'Uppsala, Sweden', birthdate: '1989-12-03', affiliation: null, country: [], releasedate: '2023-05-30', gadget: 'F-NATT DREAD MINE', gadget_desc: 'The F-NATT DREAD MINE is a throwable device that sticks to walls, so it can be hidden in places where fear can fester. Fenrir comes equipped with 4 mines and can activate 2 at a time anywhere on the map.', gadget_zh: null, gadget_zh_desc: '投掷式设备，能附着于表面，侦测发现敌人接近时，设备将释放出诱发恐惧情绪的气体。', gadget_stats: ['携带数量：4个', '可同时开启数量：2个', '作用范围：半径4米的球形', '按住能够将恐惧地雷拿在手中。', '松开即可投出。', '将准星对准部署的地雷按住，用于开启或关闭地雷。', '在地雷附近将准星对准部署的地雷按住，可回收已部署的地雷。', '恐惧地雷投掷后可黏附在任何表面，部署后处于关闭状态。关闭状态下的恐惧地雷不会检测范围内进攻方。'], weapons: ['5.7 USG', 'MP7', 'SASG-12'] },
    { name: 'Finka', side: 'atk', icon: 'finka.svg', portrait: 'images/operators/finka.webp', gadgetIcon: 'images/gadgets/finka.webp', gadgetIconName: 'Nanobot Shots', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Front Line', 'Support'], realname: 'Lera Melnikova', birthplace: 'Gomel', birthdate: '1989-06-07', affiliation: 'Spetsnaz CBRN', country: ['ru'], releasedate: '2018-03-06', gadget: 'Nanobot Shots', gadget_desc: 'Finka\'s Adrenal Surge activates pre-injected nanobots made of zinc in operators, releasing a pharmacological cocktail into their system where the zinc is absorbed as a nutrient. These nanites give her team a short boost in HP, increase aim speed and help allies out of DBNO including herself instead of the person capturing by Welcome Mat. She’s the only one capable of tailoring the nanites to specific operators.', gadget_zh: '肾上腺素激发', gadget_zh_desc: '启动纳米机器人，为队友提供生命值和短暂的强化效果，并救治包括自己在内的倒地干员。', gadget_stats: ['使用次数：3次', '持续时间：10秒', '冷却时间：18秒（从开启技能开始算起）', '技能启用的瞬间会给进攻方提供以下的增益：', '*为所有友军提供20点的治疗。若造成超出干员生命值上限的过量治疗时，超出的生命值会转变为，以1点/秒的速度消减。该治疗具有以下性质：', '**治疗可立即救起处于倒地状态的友军，使其自行起身并回复至30点血量。但被击倒、被敌方正在的友军无法被救起；', '**治疗后一旦出现则立即开始衰减；肾上腺素消失时，治疗及其产生的不会被扣除。', '*立即消除由的声波冲击、、所发射的震撼弹所造成的眩晕效果，和眩晕手榴弹、、造成的致盲效果；'], weapons: ['6P41', 'GONNE-6', 'GSH-18', 'PMM', 'SASG-12', 'Spear .308'] },
    { name: 'Flores', side: 'atk', icon: 'flores.svg', portrait: 'images/operators/flores.webp', gadgetIcon: 'images/gadgets/flores.webp', gadgetIconName: 'Flores RCE-Ratero Charge', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Anti-Gadget', 'Intel'], realname: 'Santiago Miguel Lucero', birthplace: 'Buenos Aires', birthdate: '1982-10-02', affiliation: null, country: [], releasedate: '2021-03-16', gadget: 'RCE-Ratero Charge', gadget_desc: 'Controlled from a distance, the RCE-Ratero Charge races forward while Flores scouts a location for its blast. Once triggered, the Ratero clutches onto the nearest surface, armors itself with a bulletproof shell, and explodes, destroying nearby gadgets and soft surfaces.', gadget_zh: null, gadget_zh_desc: '遥控炸药，可固定在表面上，能抵御弹药攻击，经过一定时间后引爆。', gadget_stats: ['携带数量：4个', '部署时间：1秒', '防弹引爆倒计时：3秒', '爆炸伤害：爆炸范围中心最多可造成180点伤害，最终在距爆心3m处线性衰减至15点伤害。', '*在1.5m内无遮挡的引爆可直接击倒一名干员。', '无论以何种姿态开始放置自爆车，都会在放置完毕后强制进入蹲伏状态，且无法在匍匐状态下放置。', '自爆车只能手动部署在身前，不可投掷，仅可在平整的方向上进行部署。', '在部署自爆车并进入操纵界面后，Flores共有10秒装备控制时间。'], weapons: ['AR33', 'GONNE-6', 'GSH-18', 'SR-25', 'T-95 LSW'] },
    { name: 'Frost', side: 'def', icon: 'frost.svg', portrait: 'images/operators/frost.webp', gadgetIcon: 'images/gadgets/frost.webp', gadgetIconName: 'Sterling MK2 LHT', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Anti-Entry', 'Trapper'], realname: 'Tina Lin Tsang', birthplace: 'Vancouver', birthdate: '1985-03-04', affiliation: 'JTF2', country: ['ca'], releasedate: '2016-02-02', gadget: 'Sterling MK2 LHT (Welcome Mat)', gadget_desc: 'Requiring two people to release the jaws and reset the trap. The rubber mat and concealed metal jaws are bolted in place. When the pressure plate is engaged, two sets of jaws at ankle and shin height deploy, locking the person in place.', gadget_zh: null, gadget_zh_desc: '使用机械式机关陷阱让踩上的敌人无法行动。', gadget_stats: ['可放置个数：3', '冷却时间：无', '耐久值（血量）：66', '部署耗时：2.5秒', '解除陷阱耗时：4秒', '初始数量为3，每隔60秒额外获得一次。', '最大可携带数量：3', '最大可部署数量：3'], weapons: ['9mm C1', 'ITA12S', 'Mk1 9mm', 'SUPER 90'] },
    { name: 'Fuze', side: 'atk', icon: 'fuze.svg', portrait: 'images/operators/fuze.webp', gadgetIcon: 'images/gadgets/fuze.webp', gadgetIconName: 'Cluster Charge', armor: '3', speed: 'slow', difficulty: 'easy', function: ['Anti-Gadget'], realname: 'Shuhrat Kessikbayev', birthplace: 'Samarkand', birthdate: '1982-10-12', affiliation: 'Spetsnaz', country: ['ru'], releasedate: '2015-12-01', gadget: 'APM-6 "Matryoshka" Cluster Charge', gadget_desc: 'Featuring a piston that burrows through unreinforced walls, floors and even armor panels with ease, the "Matryoshka", when anchored, shoots live cluster grenades.', gadget_zh: null, gadget_zh_desc: '部署在软墙体或加固墙体上的炸药，可歼灭墙体另一面的特勤干员或摧毁装备。', gadget_stats: ['数量：4个', '榴弹数：5枚/个', '部署时间：1.6秒', '部署于加固表面后的引爆时间：1.75秒', '初始数量为3，每隔60秒额外获得一次。', '最大可携带数量：3', '霰射炸药可以部署在任意非坚固的表面上，但是部署在加固表面与和上时需要更长时间引爆。且部署在和机动护盾上引爆时会使防弹玻璃破碎，无法观测。', '部署霰射炸药时候会发出标志性安装声：file:Fuze_skill_sound_1.flac'], weapons: ['6P41', 'AK-12', 'GSH-18', 'PMM'] },
    { name: 'Glaz', side: 'atk', icon: 'glaz.svg', portrait: 'images/operators/glaz.webp', gadgetIcon: 'images/gadgets/glaz.webp', gadgetIconName: 'HDS Flip Sight', armor: '1', speed: 'fast', difficulty: 'normal', function: ['Intel', 'Support'], realname: 'Timur Glazkov', birthplace: 'Vladivostok', birthdate: '1987-07-02', affiliation: 'Spetsnaz', country: ['ru'], releasedate: '2015-12-01', gadget: 'HDS Flip Sight', gadget_desc: 'Mounted on a hinge allowing it to flip into position, the HDS Flip Sight provides the wielder access to an unmatched level of zoom as well as the ability to see through smoke.', gadget_zh: '折叠式瞄准镜', gadget_zh_desc: '切换放大瞄准镜，可以通过复杂的影像传感器描绘出远距离标记，甚至可以穿透烟雾。', gadget_stats: ['无使用次数限制', '无使用时间限制', '无冷却时间', '折叠式瞄准镜倍率为4.0倍', '静止加载到最佳透烟状态所需时间：0.4秒', '无变化', '折叠式瞄准镜是一个附带在唯一的主要武器OTs-03上的特殊热成像倍镜。', '在游戏开始时，折叠式瞄准镜默认处于收起状态。'], weapons: ['Bearing 9', 'GONNE-6', 'GSH-18', 'OTs-03', 'PMM'] },
    { name: 'Goyo', side: 'def', icon: 'goyo.svg', portrait: 'images/operators/goyo.webp', gadgetIcon: 'images/gadgets/goyo.webp', gadgetIconName: 'Goyo Volcán Shield', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Anti-Entry', 'Trapper'], realname: 'César Ruiz Hernández', birthplace: 'Culiacán Rosales', birthdate: '1988-06-20', affiliation: 'FES', country: ['mx'], releasedate: '2019-09-11', gadget: 'Volcán Canister', gadget_desc: 'Volcán Canisters are incendiary bomb which partially shielded and can be deployed on surfaces such as walls and floors. Their explosive damage has been reduced but the flames burn for longer than they did before.', gadget_zh: null, gadget_zh_desc: '俗称：火山罐、火山盒', gadget_stats: ['数量：4', '部署所需时间：2秒', '燃烧范围半径：4.05米', '燃烧伤害：12点/0.25秒', '燃烧持续时间：20秒', '初始数量为3，每隔90秒额外获得一次。', '最大可携带数量：3', '最大可部署数量：3'], weapons: ['P229', 'TCSG12', 'Vector .45'] },
    { name: 'Gridlock', side: 'atk', icon: 'gridlock.svg', portrait: 'images/operators/gridlock.webp', gadgetIcon: 'images/gadgets/gridlock.webp', gadgetIconName: 'Gridlock Trax Stingers', armor: '3', speed: 'slow', difficulty: 'easy', function: ['Support', 'Map Control'], realname: 'Tori Tallyo Fairous', birthplace: 'Longreach, Central Queensland', birthdate: '1982-08-05', affiliation: 'SASR', country: ['au'], releasedate: '2019-03-06', gadget: 'Trax Stingers', gadget_desc: 'Thrown gadget that deploys barbed mats capable of slowing down and hurting enemies who traverse them.', gadget_zh: null, gadget_zh_desc: '投掷的装备会部署倒刺地垫，会减缓敌人的前行速度并对其造成伤害。', gadget_stats: ['数量：3', '最大展开数量：19', '展开所需时间（在地形平坦的理想状态下）：', '*部署延迟：0.45秒（第一个钉刺会在延迟后部署生效）', '*单个钉刺部署时间：0.45秒/个', '*部署随机变化范围：0.05秒/个', '*完全部署时间：9秒', '* 注：在地形有阻挡的情况下，如有不能展开的钉刺，钉刺展开进程会在此短暂停顿0.45-0.5s，停顿后继续展开。'], weapons: ['F90', 'GONNE-6', 'M249 SAW', 'SDP 9mm', 'Super Shorty'] },
    { name: 'Grim', side: 'atk', icon: 'grim.svg', portrait: 'images/operators/grim.webp', gadgetIcon: 'images/gadgets/grim.webp', gadgetIconName: 'Kawan Hive Launcher', armor: '1', speed: 'fast', difficulty: 'easy', function: ['Front Line', 'Map Control'], realname: 'Charlie Tho Keng Boon', birthplace: 'Jurong, Singapore', birthdate: '1983-04-05', affiliation: 'NDU', country: [], releasedate: '2022-09-06', gadget: 'Kawan Hive Launcher', gadget_desc: 'You\'ve heard the buzz, and the Kawan Hive Launcher is here! Firing off a projectile releases a swarm of bots that track the location of opponents who walk through it. Just don\'t get them in your eyes.', gadget_zh: null, gadget_zh_desc: '该发射器可以发射一个容器罐，释放一群微型机器人，在一定时间内可以揭露穿过所覆盖区域的敌人位置信息。', gadget_stats: ['装置使用次数：5个', '取出所需时间：1秒', '最快发射间隔：1秒', '按下取出，随后按下即可发射。', '按下可以调整发射模式。', 'Grim可以按下调整发射器的发射模式，不同发射模式的效果如下：', '* 弹射模式：发射器会以直线弹道发射储蜂罐，储蜂罐会在弹射垂直表面间弹射，在落到水平表面后0.6秒后会打开并放出蜂群机器人。', '蜂群会滞留在以机巢为中心半径4.6米，一人高度的圆柱形区域持续16秒。并实时标记范围内的全部防守方干员位置。'], weapons: ['552 Commando', 'Bailiff 410', 'P229', 'SG-CQB'] },
    { name: 'Hibana', side: 'atk', icon: 'hibana.svg', portrait: 'images/operators/hibana.webp', gadgetIcon: 'images/gadgets/hibana.webp', gadgetIconName: 'X-KAIROS', armor: '1', speed: 'fast', difficulty: 'easy', function: ['Breach', 'Front Line'], realname: 'Yumiko Imagawa', birthplace: 'Nagoya', birthdate: '1983-07-12', affiliation: 'S.A.T.', country: ['jp'], releasedate: '2016-11-17', gadget: 'X-KAIROS (40mm Caliber Launcher)', gadget_desc: 'The X-KAIROS - a 40mm caliber launcher capable of breaching reinforced walls - fires explosive pellets that can be detonated simultaneously from a distance.', gadget_zh: null, gadget_zh_desc: '这把40毫米榴弹发射器可以发射能遥控引爆的爆破弹丸。', gadget_stats: ['弹丸数：18颗', '射击模式：6颗/次、4颗/次、2颗/次', '装填时间：0.4秒', '引爆所需时间：3.8秒', '初始数量为18，每隔60秒额外获得6次。', '最大可携带数量：18', '最大可部署数量：18', '按拿出发射器，用使用红外指示来参考发射落点，按发射卡伊洛斯爆破弹。'], weapons: ['Bearing 9', 'P229', 'PMR90A2', 'SuperNova', 'Type-89'] },
    { name: 'IQ', side: 'atk', icon: 'iq.svg', portrait: 'images/operators/iq.webp', gadgetIcon: 'images/gadgets/iq.webp', gadgetIconName: 'Electronics Detector', armor: '1', speed: 'fast', difficulty: 'hard', function: ['Intel', 'Support'], realname: 'Monika Weiss', birthplace: 'Leipzig', birthdate: '1979-08-01', affiliation: 'GSG 9', country: ['de'], releasedate: '2015-12-01', gadget: 'Red MKIII "Spectre" Electronics Detector', gadget_desc: 'Wrist mounted mobile phone-sized sensor capable of detecting electronic gadgets and equipment within its range.', gadget_zh: null, gadget_zh_desc: '使用电子设备侦测器，透过障碍物，例如墙壁，探测有效范围内的电子设备。', gadget_stats: ['无使用次数上限', '扫描距离：22米', '在侦察范围内把准星移到要侦测的电子设备上即可在右上角由上到下分别显示:', '* 电子设备的种类；', '* IQ自身与目标电子设备之间的距离（以m为单位）。', 'IQ可以对扫描的敌方电子设备进行标记。通过瞄准并直接按下标记侦测到的设备，就算隔着障碍物也可以标记目标设备的准确位置。', '在使用电子设备侦测器时仅可使用副武器。', '冲刺中无法使用电子设备侦测器，但冲刺结束时依旧会回到使用电子设备侦测器的状态。'], weapons: ['552 Commando', 'AUG A2', 'G8A1', 'P12'] },
    { name: 'Iana', side: 'atk', icon: 'iana.svg', portrait: 'images/operators/iana.webp', gadgetIcon: 'images/gadgets/iana.webp', gadgetIconName: 'Iana Gemini Replicator', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Front Line', 'Intel'], realname: 'Nienke Meijer', birthplace: 'Katwijk', birthdate: '1984-8-27', affiliation: 'REU', country: ['nl'], releasedate: '2020-03-10', gadget: 'Gemini Replicator', gadget_desc: 'The Gemini Replicator is a remotely-controlled holographic copy of iana. When she deploys it, she can scout ahead with little to no consequences.', gadget_zh: null, gadget_zh_desc: '俗称：分身、假身、假人', gadget_stats: ['无使用次数限制', '分身最大持续时间：18秒', '技能冷却时间：', '*主动中断或持续时间结束：8秒', '*意外中断（被摧毁或瘫痪）：20秒', '分身生成前摇：2秒', '意外中断硬直：2秒', '按下即可使用。'], weapons: ['ARX200', 'G36C', 'GONNE-6', 'Mk1 9mm'] },
    { name: 'Jackal', side: 'atk', icon: 'jackal.svg', portrait: 'images/operators/jackal.webp', gadgetIcon: 'images/gadgets/jackal.webp', gadgetIconName: 'Eyenox Model III', armor: '2', speed: 'medium', difficulty: 'hard', function: ['Intel', 'Map Control'], realname: 'Ryad Ramírez Al-Hassar', birthplace: 'Ceuta', birthdate: '1968-02-29', affiliation: 'G.E.O.', country: ['es'], releasedate: '2017-02-07', gadget: 'Eyenox Model III', gadget_desc: 'Eyenox Model III was created to offer a mobile tracking device able to both identify and trail a person’s footprints in real-time. Equipped with advanced computer vision, the Eyenox detects invisible details relating to footfall and weight distribution so that you can identify and stalk your target.', gadget_zh: null, gadget_zh_desc: '智能脚印分析头盔3型|缩略图|260px', gadget_stats: ['扫描次数：5', '施放时间：1.5 秒', '最远扫描距离：12 米', '脚印只会出现在准备阶段结束后；', 'Jackal可以跨楼层看见并扫描脚印；', '在扫描完成后，被扫描者在地图上先前留下的全部脚印都会消失，但之后还会留下新的脚印；', '防守方留下的脚印会在留下脚印的 120 秒后 / 死亡后 / 被扫描后消失，在此之前脚印的颜色会随着时间推移而发生变化：', '当装备启动时：'], weapons: ['C7E', 'ITA12L', 'ITA12S', 'PDW9', 'USP40'] },
    { name: 'Jäger', side: 'def', icon: 'jager.svg', portrait: 'images/operators/jager.webp', gadgetIcon: 'images/gadgets/jager.webp', gadgetIconName: 'ADS-MK IV', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Anti-Gadget', 'Support'], realname: 'Marius Streicher', birthplace: 'Düsseldorf', birthdate: '1978-03-09', affiliation: 'GSG 9', country: ['de'], releasedate: '2015-12-01', gadget: 'ADS-MK IV "Magpie"', gadget_desc: 'Full range grenade launcher mountable on walls and floors featuring four surveillance cameras allowing for precise targeting of hostile equipment.', gadget_zh: null, gadget_zh_desc: '缩略图|300px|ads拦截范围', gadget_stats: ['道具数量：3个', '拦截频次：9秒/次', '无拦截次数上限', '从切换为道具至完全部署所需时间：3秒', '拦截范围：半径约为4.5m的球体', '初始数量为3，每隔60秒额外获得一次。', '最大可携带数量：3', '最大可部署数量：3'], weapons: ['416-C CARBINE', 'M870', 'P-10C', 'P12'] },
    { name: 'Kaid', side: 'def', icon: 'kaid.svg', portrait: 'images/operators/kaid.webp', gadgetIcon: 'images/gadgets/kaid.webp', gadgetIconName: 'Kaid Electroclaw', armor: '3', speed: 'slow', difficulty: 'normal', function: ['Anti-Entry', 'Anti-Gadget'], realname: 'Jalal El Fassi', birthplace: 'Aroumd, Morocco', birthdate: '1960-06-26', affiliation: 'GIGR', country: ['ma'], releasedate: '2018-12-04', gadget: '"Rtila" Electroclaw', gadget_desc: 'Kaid’s "Rtila" Electroclaw can electrify reinforced walls and hatches, barbed wire, and deployable shields, making it tougher for the enemy to breach the Kasbah and any facility he’s tasked with protecting. He enters the field with two of these throwable gadgets. Once they’ve attached themselves to a surface, they each electrify metallic objects within a 0.75 meter radius.', gadget_zh: null, gadget_zh_desc: '可以将影响范围内的加固墙面与活板门，倒刺铁丝网与机动护盾通电。', gadget_stats: ['携带数量：2', '部署时间：3.5秒', '通电半径：1.3米', '初始数量为2，每隔60秒额外获得一次。', '最大可携带数量：2', '最大可部署数量：2', '按住取出蜘蛛电抓，松开按键投出部署。', '部署后长按可收回。'], weapons: ['.44 Mag Semi-Auto', 'AUG A3', 'GONNE-6 Rev', 'LFP586', 'TCSG12'] },
    { name: 'Kali', side: 'atk', icon: 'kali.svg', portrait: 'images/operators/kali.webp', gadgetIcon: 'images/gadgets/kali.webp', gadgetIconName: 'Kali LV Explosive Lance', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Anti-Gadget', 'Support'], realname: 'Jaimini Kalimohan Shah', birthplace: 'Amreli', birthdate: '1985-08-21', affiliation: 'NIGHTHAVEN', country: [], releasedate: '2019-12-03', gadget: 'LV Explosive Lance', gadget_desc: 'To talk about the LV Explosive Lance, we need to mention Kali’s CSRX 300. It’s a dangerous weapon that can breach barricades and hatches in a single shot, and create big holes in breakable walls. The LV is its under-barrel, and it can be used at the same time as the CSRX 300’s scopes.', gadget_zh: null, gadget_zh_desc: '俗称：穿墙弹、尖枪', gadget_stats: ['使用次数：4', '施放时间：瞬发，接触到平面后1.5s引爆。', '伤害范围：半径为3.5m的球形（无法穿透除加固墙外的不可破坏墙面），中心伤害为5点，随距离衰减至0。', '初始数量为4，每隔60秒额外获得一次。', '最大可携带数量：4', '按下能够在主武器和装备之间切换；', '对准目标并按下即可发射。', '低速爆破尖枪会在发射后经过一段时间的延迟后爆炸，爆炸时：'], weapons: ['C75 Auto', 'CSRX 300', 'P226 MK 25', 'SPSMG9'] },
    { name: 'Kapkan', side: 'def', icon: 'kapkan.svg', portrait: 'images/operators/kapkan.webp', gadgetIcon: 'images/gadgets/kapkan.webp', gadgetIconName: 'EDD MK II', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Anti-Entry', 'Trapper'], realname: 'Maxim Basuda', birthplace: 'Kovrov', birthdate: '1979-05-14', affiliation: 'Spetsnaz', country: ['ru'], releasedate: '2015-12-01', gadget: 'EDD MK II Entry Denial Device', gadget_desc: 'C4 charge that may be mounted into windows and door frames.', gadget_zh: null, gadget_zh_desc: '俗称：诡雷、EDD', gadget_stats: ['道具数量：5', '爆炸伤害：62', '部署完后会射出一道短暂延迟后隐形的红外激光作为引信，当进攻方触碰到激光时引爆该装置。', '每一个门框或者窗框可以部署多个EDD，同时触发会叠加伤害。', 'Kapkan在门框部署EDD时，以不同的姿势和视角高度部署的EDD触发高度也会不一样。对于敌方玩家而言，在不同的高度下均可以用不同的方式来避免触发：', '* 腹部以上高度：可以采取蹲姿或匍匐来安全通过；', '* 腹部以下高度：仅能以匍匐来安全通过；', '* 足踝部的高度：仅能在有障碍的情况下利用翻越并安全通过，可翻越的障碍包括封阻板（破损时）、机动护盾、。'], weapons: ['9x19VSN', 'GSH-18', 'PMM', 'SASG-12'] },
    { name: 'Lesion', side: 'def', icon: 'lesion.svg', portrait: 'images/operators/lesion.webp', gadgetIcon: 'images/gadgets/lesion.webp', gadgetIconName: 'Gu Mine', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Anti-Entry', 'Trapper'], realname: 'Liu Tze Long', birthplace: 'Tseung Kwan O', birthdate: '1972-07-02', affiliation: 'S.D.U.', country: ['hk'], releasedate: '2017-09-05', gadget: 'Gu Mine', gadget_desc: 'Gu mines were inspired by the sharp punji sticks used during the Vietnam War. Rubbed with toxic plants or feces, the stakes served to slow down enemy troops by causing severe infections in their camp. Similarly, Gu mines inject a toxin that injure your opponent and limit their speed.', gadget_zh: null, gadget_zh_desc: '剧毒地雷会将化合物注射到敌人体内，造成伤害并且限制移动速度。', gadget_stats: ['道具数量：1+7个', '生成所需时间：25秒/个', '触发伤害：3点', '持续伤害：12点/2秒', '拔除毒针所需时间：2.5秒', '按下拿出，松开后向指定方位投掷', '*对于已经部署的蛊针陷阱，站在旁边对准其按住即可回收。', '蛊针陷阱在投出后需要碰撞一次才能进入部署状态，且在位置不足以展开的情况下不会进入部署状态。'], weapons: ['Q-929', 'SIX12 SD', 'T-5 SMG'] },
    { name: 'Lion', side: 'atk', icon: 'lion.svg', portrait: 'images/operators/lion.webp', gadgetIcon: 'images/gadgets/lion.webp', gadgetIconName: 'EE-ONE-D', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Intel', 'Map Control'], realname: 'Olivier Flament', birthplace: 'Toulouse', birthdate: '1985-08-29', affiliation: 'GIGN CBRN', country: ['fr'], releasedate: '2018-03-06', gadget: 'EE-ONE-D', gadget_desc: 'Twitch provided him with an aerial drone while he served with GIGN. The EE-ONE-D helps Lion maintain quarantine by detecting movement in an area, giving an overview of hot zones or of the battlefield. His drone can stay airborne indefinitely, but he must choose the right moment to perform his scans.', gadget_zh: null, gadget_zh_desc: 'EE-ONE-D无人探测侦察机会侦测敌人的行动，在扫描期间暴露敌人的所在位置。', gadget_stats: ['使用次数：3', '侦测提示：1.4秒', '持续时间：3秒', '冷却时间：15秒', '当出场时，地图上方会出现一个飞行状态中的EE-ONE-D无人机，外形为圆形且不可被破坏。', '当使用扫描时，会出现以下提示效果：', '*Lion抬起手臂，发出微弱的扫描声，并有1.28秒硬直；', '*全体干员在抬头显示中有圆形倒计时提示，并听到倒计时提示音；'], weapons: ['417', 'GONNE-6', 'LFP586', 'P9', 'SG-CQB', 'V308'] },
    { name: 'Maestro', side: 'def', icon: 'maestro.svg', portrait: 'images/operators/maestro.webp', gadgetIcon: null, gadgetIconName: null, armor: '3', speed: 'slow', difficulty: 'normal', function: ['Anti-Gadget', 'Intel'], realname: 'Adriano Martello', birthplace: 'Rome', birthdate: '1973-4-13', affiliation: 'G.I.S', country: ['it'], releasedate: '2018-06-07', gadget: 'Evil Eye', gadget_desc: 'Remote-controlled turret firing high-energy laser beams. Once affixed to the floor or wall, Maestro can remote-surveil and provide overwatch in a location through the swivel-mounted camera. When the camera device breaks open to fire a laser beam the core is exposed to damage. Otherwise, the turret is unaffected by bullets and melee. Lastly, Evil Eye can see through smoke.', gadget_zh: '“邪眼”摄像头', gadget_zh_desc: '俗称：邪眼、炮台', gadget_stats: ['数量：3', '伤害：5HP/发', '最大持续连射时间：8秒', '最大能量恢复时间：8秒', '最大连射伤害：165HP', '按下拿出，在可部署表面上长按进行部署。', '部署完毕后按下或进行观测和操控。', '*在观测界面通过移动鼠标可控制“邪眼”摄像头的方向。'], weapons: ['ACS12', 'ALDA 5.56', 'Bailiff 410', 'Keratos .357'] },
    { name: 'Maverick', side: 'atk', icon: 'maverick.svg', portrait: 'images/operators/maverick.webp', gadgetIcon: null, gadgetIconName: null, armor: '1', speed: 'fast', difficulty: 'normal', function: ['Breach', 'Front Line'], realname: 'Erik Thorn', birthplace: 'Boston', birthdate: '1982-04-20', affiliation: 'The Unit GSUTR', country: ['us'], releasedate: '2018-09-04', gadget: 'Exothermic-S "SURI" Torch', gadget_desc: 'Maverick’s D.I.Y. blowtorch can breach any surface, including reinforced walls and hatches. It requires a steady hand and knowledge of the environment to create small holes and lines of sight. Maverick must be in close range to use his gadget on the chosen surface.', gadget_zh: '直接清空', gadget_zh_desc: '俗称：焊枪、喷灯', gadget_stats: ['携带量：2瓶', '气容量：160单位/瓶', '持续时间：12.8秒/瓶', '填装时间：0.5秒', '对干员伤害：25/秒', '按下取出或收起突破用发焰设备', '按住使用，可以按住进行匀速切割。', '按下会直接清空当前剩余燃料并更换新的燃料瓶。'], weapons: ['1911 TACOPS', 'AR-15.50', 'M4', 'Reaper MK2'] },
    { name: 'Melusi', side: 'def', icon: 'melusi.svg', portrait: 'images/operators/melusi.webp', gadgetIcon: 'images/gadgets/melusi.webp', gadgetIconName: 'Melusi Banshee Sonic Defense', armor: '3', speed: 'slow', difficulty: 'easy', function: ['Crowd Control', 'Intel'], realname: 'Thandiwe Ndlovu', birthplace: 'Louwsburg', birthdate: '1988-6-16', affiliation: 'ITF', country: [], releasedate: '2020-06-16', gadget: 'Banshee Sonic Defense', gadget_desc: 'The Banshee Sonic Defense is deployable on surfaces, much like Maestro’s Evil Eyes, but they don’t require any manual control, as soon as an opponent walks close enough to it, it will release its scream and slow them.', gadget_zh: null, gadget_zh_desc: '|缩略图|260px', gadget_stats: ['持有数量：4', '部署时间：2s/个', '生效时间：2.5s', '作用半径：以技能为中心，半径为4.3m的半球体', '点击取出', '对准平面按住部署', 'Melusi的技能需要一定时间来生效，进程会以类似的一样，以白色圆圈显示作用范围和启动进程。', '*声波装置在未被触发的情况下会处于待机状态，此时装置的防护罩会处于闭合状态；'], weapons: ['ITA12S', 'MP5', 'RG15', 'SUPER 90'] },
    { name: 'Mira', side: 'def', icon: 'mira.svg', portrait: 'images/operators/mira.webp', gadgetIcon: 'images/gadgets/mira.webp', gadgetIconName: 'Black Mirror', armor: '3', speed: 'slow', difficulty: 'hard', function: ['Intel', 'Support'], realname: 'Elena María Álvarez', birthplace: 'Madrid', birthdate: '1977-11-18', affiliation: 'G.E.O.', country: ['es'], releasedate: '2017-02-07', gadget: 'Black Mirror', gadget_desc: 'A one-way bulletproof mirror placeable on breakable and reinforcable walls. The window can also be ejected to create a murder hole.', gadget_zh: '单向窗口', gadget_zh_desc: '在可破坏墙面与已加固墙面上部署一面单向防弹玻璃。也可以卸除玻璃来制造出射击口。', gadget_stats: ['数量：2', '按下取出，对准需要部署的位置按住部署。', '黑镜是一块不可被任何枪械穿透的单向窗口，一般来说玩家将纯黑不可透视的那一面称为前面，将可透视的一面称为后面。', '可以通过对黑镜镜面近战攻击使防弹玻璃破碎，无法进行观察，但依然防弹。、、和所发射的弹丸在黑镜镜面上引爆或启动时也会使玻璃破碎。', '摧毁黑镜的方法：', '* 对于安装在加固墙上的黑镜：', '** 的不可以贴在黑镜上，只能贴在黑镜周围的加固墙上，将整面加固墙炸毁的同时摧毁黑镜；', '** 的射出的弹丸可以吸附在黑镜上，只要有1颗弹丸吸附在黑镜上成功爆炸就能摧毁黑镜；'], weapons: ['ITA12L', 'ITA12S', 'USP40', 'Vector .45'] },
    { name: 'Montagne', side: 'atk', icon: 'montagne.svg', portrait: 'images/operators/montagne.webp', gadgetIcon: 'images/gadgets/montagne.webp', gadgetIconName: 'Extendable Shield', armor: '3', speed: 'slow', difficulty: 'hard', function: ['Intel', 'Support'], realname: 'Gilles Touré', birthplace: 'Bordeaux', birthdate: '1968-10-11', affiliation: 'GIGN', country: ['fr'], releasedate: '2015-12-01', gadget: '"Le Roc" Extendable Shield', gadget_desc: 'Made from a composite of reinforced alloys and Kevlar, "Le Roc" is capable of collapsing into half its size, allowing for increased mobility to its wielder.', gadget_zh: null, gadget_zh_desc: '俗称：（举盾）大盾、全盾', gadget_stats: ['单击可以伸缩两种状态间来回切换。', '游戏开始时默认手持伸缩护盾，按下或滚动可以在手持和把伸缩护盾背在身后之间切换；', '护盾背在身后时单击会切换至手持并伸展护盾。', '伸缩盾完全展开后，会获得正前方的全身防护，防护过程中：', '*可以移动或缓慢移动，不能下蹲、侧身、匍匐、翻越、挂绳；', '*不能瞄准、开火和使用道具、无人机；', '*可以按给队友提供标记；', '*调转视角范围进一步受限，看不到眼前的底部位置；'], weapons: ['LFP586', 'P9'] },
    { name: 'Mozzie', side: 'def', icon: 'mozzie.svg', portrait: 'images/operators/mozzie.webp', gadgetIcon: 'images/gadgets/mozzie.webp', gadgetIconName: 'Mozzie Pest Launcher', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Anti-Gadget', 'Intel'], realname: 'Max Goose', birthplace: 'Portland', birthdate: '1984-02-15', affiliation: 'SASR', country: ['au'], releasedate: '2019-03-06', gadget: 'Pest Launcher', gadget_desc: 'Launches autonomous bots that latch onto nearby enemy drones, hijacking their controls.', gadget_zh: '骇虫发射器', gadget_zh_desc: '俗称：偷车、黑小车、恐怖机器人、抱脸虫', gadget_stats: ['数量：4', '部署后就绪所需时间：1.7秒', '作用范围半径：1.75米', '装填时间：2秒', '骇虫可以入侵到进攻方的无人机，并且使Mozzie获得完整的控制权。保留无人机的所有功能，但却不能把无人机收起来随身携带。', '骇虫发射器可以直接击中无人机，或者朝平面射击作为伏击进攻方无人机的陷阱。', '*骇虫为中心球形半径1.75米范围以内且没有其他障碍物的情况下，进入范围内的无人机会被夺取控制权。', '可以骇入夺取控制权的无人机：'], weapons: ['Commando 9', 'P10 RONI', 'SDP 9mm'] },
    { name: 'Mute', side: 'def', icon: 'mute.svg', portrait: 'images/operators/mute.webp', gadgetIcon: 'images/gadgets/mute.webp', gadgetIconName: 'Jammer R6S transparent', armor: '3', speed: 'slow', difficulty: 'easy', function: ['Anti-Gadget', 'Crowd Control'], realname: 'Mark Chander', birthplace: 'York', birthdate: '1991-10-11', affiliation: 'S.A.S.', country: ['uk'], releasedate: null, gadget: 'GC90 Signal Disrupter', gadget_desc: 'He brings with him a Signal Disruptor from his former career, which allows Chandar to jam all communications in a set area, preventing remote detonations, the use of drones and him and his teammates can remain hidden from Lion’s scan if within range of the jammer. The GC90 “Moni”, blocks the signal from a remote detonator or control from reaching any device within range.', gadget_zh: null, gadget_zh_desc: '俗称：WiFi、路由器', gadget_stats: ['数量：4', '作用范围：半径2.6米的球形。', '干扰警告范围：半径4.875米的球形。', '部署所需时间：2秒', '信号干扰器只能部署在地面或宽大桌面等有足够空间部署的水平面上。', '多数情况下，干扰器的作用是干扰电子设备之间的信号传递，在范围内需要接收或传递信号的设备和部分进入范围的敌方干员都会被影响，以下列出部分影响效果，包括但不限于：', '* 爆破炸药、、、等需要遥控触发的电子设备；', '* 侦察无人机、、、等观测工具设备；'], weapons: ['M590A1', 'MP5K', 'P226 MK 25', 'SMG-11'] },
    { name: 'Nomad', side: 'atk', icon: 'nomad.svg', portrait: 'images/operators/nomad.webp', gadgetIcon: 'images/gadgets/nomad.webp', gadgetIconName: 'Nomad Airjab Launcher', armor: '2', speed: 'medium', difficulty: 'hard', function: ['Front Line', 'Map Control'], realname: 'Sanaa El Maktoub', birthplace: 'Marrakesh, Morocco', birthdate: '1979-07-27', affiliation: 'GIGR', country: ['ma'], releasedate: '2018-12-04', gadget: 'Airjab Launcher', gadget_desc: 'Nomad’s custom rifle attachment allows her to launch Airjab repulsion grenades. They can explode midair when in close proximity to an enemy or they can stick to a surface and detonate later, again when an enemy is within range. Nomad enters the field with three Airjab grenades. These pushback devices are non-lethal but they disorient those affected.', gadget_zh: null, gadget_zh_desc: '步枪的配件，可以射出有黏性的推斥榴弹，接近敌人时引爆。', gadget_stats: ['使用次数：3', '激活范围：3.25米', '作用范围：3.5米', '初始数量为2，每隔60秒额外获得一次。', '最大可携带数量：2', '最大可部署数量：2', '按下激活，按下即可发射部署气震槌', '*可按下进行瞄准，此时射出的气震槌会略微偏向准星左侧位置。'], weapons: ['.44 Mag Semi-Auto', 'AK-74M', 'ARX200', 'GONNE-6 Rev', 'PRB92'] },
    { name: 'Noor', side: 'def', icon: null, portrait: null, gadgetIcon: null, gadgetIconName: null, armor: '2', speed: 'medium', difficulty: null, function: ['Anti-Shield', 'Area Denial'], realname: 'Ahmed Murad', birthplace: 'Beni Suef, Egypt', birthdate: '4月3日（官方页面标注 28 岁）', affiliation: 'Unit 777', country: ['eg'], releasedate: '2026-09-01', gadget: 'Horus Lance Launcher', gadget_desc: '发射 5 发穿透火焰弹，可穿透护盾并进行区域封锁（Ubisoft Y11S3 官方公告）', gadget_zh: '荷鲁斯之枪发射器', gadget_zh_desc: '简称：荷鲁斯之枪', gadget_stats: ['备弹数量：2+3个', '直击伤害：50点', '火焰伤害：12点/0.25秒', '火焰持续时间：10秒', '常规部署火焰释放延迟：1.5秒', '加固墙部署、牙刃壁障、龙鳞版火焰释放延迟：5秒', '按下拿出发射器，按下以发射。', '按住可以进行瞄准。'], weapons: ['1911 TACOPS', 'ALDA 5.56', 'Bailiff 410', 'Commando 9'] },
    { name: 'Nøkk', side: 'atk', icon: 'nokk.svg', portrait: 'images/operators/nokk.webp', gadgetIcon: 'images/gadgets/nokk.webp', gadgetIconName: 'Nøkk', armor: '2', speed: 'medium', difficulty: 'hard', function: ['Front Line', 'Map Control'], realname: 'Karina Gaarddhøje', birthplace: null, birthdate: null, affiliation: 'Jægerkorpset', country: ['dk'], releasedate: '2019-06-11', gadget: 'Hel Presence Reduction', gadget_desc: 'Counter-intel that wipes Nøkk\'s image from observation tools.', gadget_zh: '隐逸无痕消除器', gadget_zh_desc: '反情报可以令观测工具无法察觉其存在。', gadget_stats: ['使用次数：无限制', '最大使用时间：无限制或异常状态13秒', '最大充能时间：120秒', '关闭冷却：0.8秒', '技能主动开关硬直：0.2秒', 'Nøkk的技能可以抹除其在敌方监控设备里的影像，且无法被敌方标记：包括观测设备标记和触发。', '技能在正常运作期间不会消耗能量，可以无限使用。', '导致技能异常的情况：'], weapons: ['5.7 USG', 'D-50', 'FMG-9', 'GONNE-6', 'PMR90A2', 'SIX12 SD'] },
    { name: 'Oryx', side: 'def', icon: 'oryx.svg', portrait: 'images/operators/oryx.webp', gadgetIcon: 'images/gadgets/oryx.webp', gadgetIconName: 'Oryx Remah Dash', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Support'], realname: 'Saif Al Hadid', birthplace: 'Azraq', birthdate: '1975-7-3', affiliation: null, country: [], releasedate: '2020-03-10', gadget: 'Remah Dash', gadget_desc: 'The Remah Dash is his signature move, its speed allows him to roam efficiently and cover short distances with unprecedented swiftness. It can also be used to knock down opponents, which gives him a unique way to deal with an Operator like Montagne.', gadget_zh: '双重战线', gadget_zh_desc: 'Oryx拥有2个相互独立且无关联的特性/技能。', gadget_stats: ['最大冲锋距离：5米', '突破可破坏墙面所须消耗生命值：5/次', '充能所需时间：5秒/次', '充能上限：3', '冲撞后僵直时间：0.5秒', '初始数量为3，每隔8秒额外获得一次。', '最大可携带数量：3', '按下即可使用。'], weapons: ['Bailiff 410', 'Reaper MK2', 'SPAS-12', 'T-5 SMG', 'USP40'] },
    { name: 'Osa', side: 'atk', icon: 'osa.svg', portrait: 'images/operators/osa.webp', gadgetIcon: 'images/gadgets/osa.webp', gadgetIconName: 'Talon-8 Clear Shield', armor: '3', speed: 'slow', difficulty: 'normal', function: ['Intel', 'Support'], realname: 'Anja Katarina Janković', birthplace: 'Split, Croatia', birthdate: '1994-04-29', affiliation: 'NIGHTHAVEN', country: [], releasedate: '2021-09-07', gadget: 'Talon-8 Clear Shield', gadget_desc: 'The transparent and bulletproof Talon-8 Shield can be carried by Osa or deployed on floors or window frames, giving her a protective line of sight while she formulates an attack strategy.', gadget_zh: null, gadget_zh_desc: '透明防弹护盾，可手持或部署在地板和窗框上。', gadget_stats: ['数量：2', '部署时间：1.8秒', '按下拿出护盾。', '按住部署护盾。', '对已部署且未破碎的护盾，按住回收。', '透明护盾可以完全抵挡子弹与激光伤害。', '当Osa手持透明护盾时：', '* 站立会露出腿部，蹲下可保护全身，但移动时会露出脚；'], weapons: ['556XI', 'PDW9', 'PMM'] },
    { name: 'Pulse', side: 'def', icon: 'pulse.svg', portrait: 'images/operators/pulse.webp', gadgetIcon: 'images/gadgets/pulse.webp', gadgetIconName: 'HB-5 Cardiac Sensor', armor: '1', speed: 'fast', difficulty: 'hard', function: ['Intel', 'Support'], realname: 'Jack Estrada', birthplace: 'Goldsboro, North Carolina', birthdate: '1984-10-11', affiliation: 'SWAT', country: ['us'], releasedate: '2015-12-01', gadget: 'HB-5 Cardiac Sensor', gadget_desc: 'This heartbeat detector can read thermal signatures through walls and other obstacles.', gadget_zh: '心跳传感器', gadget_zh_desc: '俗称：心跳、相机（拍照）', gadget_stats: ['感应距离：10.5米', '取出所需时间：1.5秒', '收回所需时间：1秒', '*设备启用时，Pulse无法使用武器，但可以标记位置。', '心跳传感器扫描范围为半径10.5米的扇形；', '心跳传感器会受到以下技能效果影响：', '*受的影响的干员可以在1.5倍距离，即远至15米内被侦测到。', '*启用时会被的侦测到心跳传感器的所在位置。'], weapons: ['5.7 USG', 'M1014', 'M45 MEUSOC', 'Reaper MK2', 'UMP45'] },
    { name: 'Ram', side: 'atk', icon: 'ram.svg', portrait: 'images/operators/ram.webp', gadgetIcon: 'images/gadgets/ram.webp', gadgetIconName: 'BU-GI Auto Breacher', armor: '3', speed: 'slow', difficulty: 'normal', function: ['Breach', 'Anti-Gadget'], realname: 'Bo-Ram Choi', birthplace: 'Busan, South Korea', birthdate: '1986-04-25', affiliation: null, country: [], releasedate: '2023-08-29', gadget: 'BU-GI Auto Breacher', gadget_desc: 'Very little can stand in the way of the new BU-GI Auto Breacher. This deployable mini-tank destroys all breakable surfaces and devices in its way along a set path, leaving a trail of destruction in its wake.', gadget_zh: '隔墙', gadget_zh_desc: '“龟甲”自动突破设备|缩略图|260px', gadget_stats: ['持有数量：3辆', '启动后持续：10秒', '直行速度：1米/秒', '行进方向：直行/左前/右前', '设备伤害：5点/0.5秒', '“龟甲”突破车体积较大且重量较重，所以无法抛至较远距离，也无法通过小车洞。车辆抛出后只有落到平面才能启用。', '突破车除尾部的红色压缩气罐外的所有部位均可防御射击以及近战攻击。', '突破车免疫电流，其无法被与的电流破坏。'], weapons: ['LMG-E', 'Mk1 9mm', 'R4-C'] },
    { name: 'Rauora', side: 'atk', icon: 'rauora.svg', portrait: 'images/operators/rauora.webp', gadgetIcon: null, gadgetIconName: null, armor: '2', speed: 'medium', difficulty: 'normal', function: ['Support', 'Map Control'], realname: 'Hāpai Iwini', birthplace: 'Christchurch, New Zealand', birthdate: '1996-05-11', affiliation: null, country: [], releasedate: '2025-03-04', gadget: 'D.O.M. Panel Launcher', gadget_desc: 'Seize control over the map with Rauora’s D.O.M. Panel Launcher. Deploy bulletproof panels from a distance and strategically control the flow of combat. With a quick trigger at the top of the door, open or close the panel to create tactical opportunities.', gadget_zh: '无法部署', gadget_zh_desc: '发射器，能将可伸缩防弹装甲板发射至门框。', gadget_stats: ['使用次数：4个；', '可射击部署范围：2~25米；', '射击间隔：1秒；', '面板检测干员范围：6米；', '卷帘门检测无人机范围：1米；', '友方收起卷帘门的时间：1.5秒；', '敌方收起卷帘门的时间：6秒；', '友方展开卷帘门的时间:1秒'], weapons: ['417', 'GSH-18', 'M249', 'Reaper MK2', 'XK23'] },
    { name: 'Rook', side: 'def', icon: 'rook.svg', portrait: 'images/operators/rook.webp', gadgetIcon: 'images/gadgets/rook.webp', gadgetIconName: 'R1N Rhino Armor', armor: '3', speed: 'slow', difficulty: 'easy', function: ['Support'], realname: 'Julien Nizan', birthplace: 'Tours', birthdate: '1990-01-06', affiliation: 'GIGN', country: ['fr'], releasedate: '2015-12-01', gadget: 'R1N "Rhino" Armor', gadget_desc: 'A multi-hit boron ceramic plate with a special spall-stop coating, and a back-face deformation (BFD) plate stored in a light weight sturdy satchel for rapid field deployment.', gadget_zh: null, gadget_zh_desc: '俗称：盒饭、衣服、女装', gadget_stats: ['护甲包数量：1个', '防弹插板数量：5个', '部署时间：1.8秒', '护甲包血量：100', '按下取出护甲包，按住部署在地面上。持续按住会在部署后直接为自己装备一块防弹插板，松开则停止。', '未装备防弹插板的干员，站在护甲包旁对其按住即可装备一块防弹插板。', '装备防弹插板的干员在倒地后，可以按住来奋起。', '拿出护甲包后按住原地在脚下放置，内含有5块防弹插板，位置及数量通过蓝色护甲图标20px在防守方全体玩家的抬头显示中直观表现。'], weapons: ['LFP586', 'MP5', 'P9', 'P90', 'Reaper MK2', 'SG-CQB'] },
    { name: 'Sens', side: 'atk', icon: 'sens.svg', portrait: 'images/operators/sens.webp', gadgetIcon: 'images/gadgets/sens.webp', gadgetIconName: 'R.O.U. Projector System', armor: '1', speed: 'fast', difficulty: 'normal', function: ['Support', 'Map Control'], realname: 'Néon Ngoma Mutombo', birthplace: 'Brussels, Belgium', birthdate: '1992-03-03', affiliation: 'Belgian Special Forces Group (B-SFG)', country: [], releasedate: '2022-06-14', gadget: 'R.O.U. Projector System', gadget_desc: 'R.O.U. Projector System rolls after it\'s thrown by Sens and drops small projectors to create a screen along its path. Although physical objects can still pass through the screen, it\'s highly flexible—cutting off multiple lines of sight at once.', gadget_zh: '双重战线', gadget_zh_desc: '可投掷滚动型设备，配备照明系统，可以投射出一道阻挡视线的光影幕墙。', gadget_stats: ['数量：4', '滚轮投放投影器个数：7个', '单面光幕长度：0.75米', '首个投影器到末个投影器最远距离（直线）：12米', '单个投影器（光墙）运行时间：15秒', '初始数量为3，每隔60秒额外获得一次。', '最大可携带数量：3', '最大可部署数量：3'], weapons: ['417', 'GONNE-6', 'POF-9', 'SDP 9mm', 'XK23'] },
    { name: 'Sentry', side: 'def', icon: 'sentry.svg', portrait: 'images/operators/sentry.webp', gadgetIcon: null, gadgetIconName: null, armor: '2', speed: 'medium', difficulty: 'easy', function: ['Support'], realname: null, birthplace: null, birthdate: null, affiliation: null, country: [], releasedate: '2024-06-11', gadget: null, gadget_desc: null, gadget_zh: '装备包', gadget_zh_desc: '===操作方法===', gadget_stats: ['Striker和Sentry的属性都为二甲二速，且拥有相同的技能：装备包。', '装备包可以让Striker和Sentry同时选择两种对应阵营的次要装备，但同一件装备不可以选择两次。', '主要装备破片手榴弹、烟雾弹或是电磁脉冲式冲击弹需要按下掷出，而贴片炸药需要在软墙前按下掏出来再按下（进阶部署为按住）部署', '次要装备闪光弹按下掷出，而阔剑地雷与硬突破炸药需要分别在足够的地面空间上与软墙/加固墙前前按下掏出来再按下（进阶部署为按住）', '主要装备冲击手榴弹，遥控炸药与感应警报器需要按下掷出。', '次要装备防弹摄像头可以在任意平整的表面按住进行部署（包括墙面，木板与地面），而倒刺铁丝网与机动护盾只能按住部署在地面上。', '*需要注意的是，机动护盾对地面空间的要求相对于铁丝网来说较大，且机动护盾即使拿在手里也具备防弹的功能，与其有相同功能的的还有的。'], weapons: ['C75 Auto', 'Commando 9', 'M870', 'Super Shorty', 'TCSG12'] },
    { name: 'Skopos', side: 'def', icon: 'skopos.svg', portrait: null, gadgetIcon: 'images/gadgets/skopos.webp', gadgetIconName: 'V10 Pantheon Shells', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Intel', 'Support'], realname: 'Kure Galanos', birthplace: 'Nicosia, Cyprus', birthdate: '1982-07-25', affiliation: 'Hellenic Armed Forces', country: ['gr'], releasedate: '2024-09-10', gadget: 'V10 Pantheon Shells', gadget_desc: 'With a pair of V10 Pantheon Shells, Skopós enters the battlefield in control of one as an Operator and the other as an Observation Tool protected by a reinforced shield. While she can only operate one at a time and will lose connection to both shells if one is destroyed, she can switch between them at will, making Skopós an effective intel and support Operator.', gadget_zh: null, gadget_zh_desc: '一对远程操控的机器人，可用作特勤干员和观察工具，两者可以切换。', gadget_stats: ['装置数量：2', '技能使用次数：无限', '切换时间：1.3秒', '切换冷却时间：0.5秒', '按切换到另一台机器人的观测工具视角；', '在条件允许的情况下，按住可进行切换转移。', '万神殿攻壳有两种颜色，其外观有些许不同：X-1为，其型号标注在背部；X-2为土黄色，其型号标注在背部和两侧的肩甲上，头部有明显天线。', '在游戏开始时，Skopós就会将两台万神殿攻壳机器人部署到防守目标点内，玩家会操作X-2机器人，机器人为待机状态。'], weapons: ['P229', 'PCX-33'] },
    { name: 'Sledge', side: 'atk', icon: 'sledge.svg', portrait: 'images/operators/sledge.webp', gadgetIcon: 'images/gadgets/sledge.webp', gadgetIconName: 'Breaching Hammer', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Breach', 'Anti-Gadget'], realname: 'Seamus Cowden', birthplace: 'John o\'Groats', birthdate: '1982-04-02', affiliation: 'S.A.S.', country: ['uk'], releasedate: '2015-12-01', gadget: 'The Caber (Tactical Breaching Hammer)', gadget_desc: 'The Breaching Hammer is capable of making doors in destructible walls and instantly destroying barricades. Additionally, the Breaching Hammer can be used as a melee weapon and to destroy barbed wire.', gadget_zh: null, gadget_zh_desc: '使用战术突破锤来突破可以破坏的表面。', gadget_stats: ['使用次数：25', '冷却时间：无', '具有涵盖并高于近战攻击的基础属性，包括对干员具有一击必杀的特性。攻击距离比近战攻击稍远，但攻击前摇时间较长。', '使用战术突破锤锤击门窗封阻板、未加固的活板门可一击将其完全破坏。', '战术突破锤能在软平面上制造一个约为2.5米的矩形洞口。', '对软墙面进行破坏后会出现一个形状为矩形且可供人通行的洞。', '对地板或者天花板，以及某些软墙面，破坏后会显现出房屋的金属承重结构。只能用于交火，不可供人通过。', '战术突破锤可以更高效地摧毁一些无法用枪械或近战攻击直接摧毁的装备，包括但不限于：'], weapons: ['L85A2', 'M590A1', 'P226 MK 25', 'Reaper MK2', 'SMG-11'] },
    { name: 'Smoke', side: 'def', icon: 'smoke.svg', portrait: 'images/operators/smoke.webp', gadgetIcon: 'images/gadgets/smoke.webp', gadgetIconName: 'Gas Grenade R6S transparent', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Anti-Entry', 'Trapper'], realname: 'James Porter', birthplace: 'London', birthdate: '1981-05-14', affiliation: 'S.A.S.', country: ['uk'], releasedate: '2015-12-01', gadget: 'Compound Z8 (Remote Gas Grenade)', gadget_desc: 'Throwable canister containing a toxic gas. Sticks to any surface and can be remotely detonated at will.', gadget_zh: '遥控毒气手榴弹', gadget_zh_desc: '俗称：毒气、毒气罐、毒辣宝贝', gadget_stats: ['毒气范围：半径3.6米', '毒气持续时间：10秒', '毒气伤害：15点/0.66秒', '初始数量为3，每隔60秒额外获得一次。', '最大可携带数量：3', '按住取出遥控毒气手榴弹，松开投出部署。', '单击引爆已部署的遥控毒气手榴弹。引爆后才能部署下一个遥控毒气手榴弹。', '毒气罐投出后可贴附于任意表面。'], weapons: ['FMG-9', 'M590A1', 'P226 MK 25', 'SMG-11'] },
    { name: 'Solid Snake', side: 'atk', icon: 'images/operators/solid-snake.png', portrait: 'images/operators/solid-snake.webp', gadgetIcon: 'images/gadgets/solid-snake.webp', gadgetIconName: 'Soliton Radar Mk. III', armor: '1', speed: 'fast', difficulty: 'normal', function: ['Intel', 'Front Line'], realname: 'David', birthplace: 'United States', birthdate: '\'\'Redacted\'\'', affiliation: null, country: [], releasedate: '2026-03-03', gadget: 'Soliton Radar Mk. III', gadget_desc: 'Find nearby enemy threats with Solid Snake\'s Soliton Radar Mk. III, a handheld device with a minimap that marks any hostiles present. Use the device\'s precision mode to pinpoint threats, but be wary, as this will alert enemies that they\'ve been detected by Solid Snake. The Radar provides a view of immediate surroundings, making it an excellent tool for recon that allows allies to lay groundwork and take map control quickly. While hunting down enemies, Solid Snake can also scavenge gadgets from fallen Operators to adapt to the ever-changing needs of the battle.', gadget_zh: '常规', gadget_zh_desc: '能探测并显示敌方威胁的手持雷达。', gadget_stats: ['使用次数：无限制', '常规模式最大持续时间：10秒', '最大充能时间：8秒', '精确模式使用次数：4', '精确模式最大持续时间：4秒', '关闭技能冷却时间：3秒', '扫描范围：以Solid Snake为圆心，半径16米的圆形', '按下拿出雷达进行扫描。'], weapons: ['F2', 'PMR90A2', 'TACIT .45'] },
    { name: 'Solis', side: 'def', icon: 'solis.svg', portrait: 'images/operators/solis.webp', gadgetIcon: 'images/gadgets/solis.webp', gadgetIconName: 'SPEC-IO Electro-Sensor', armor: '2', speed: 'medium', difficulty: 'hard', function: ['Intel', 'Support'], realname: 'Ana Valentina Díaz', birthplace: 'Zipaquirá, Colombia', birthdate: '1985-09-18', affiliation: 'AFEAU', country: [], releasedate: '2022-11-21', gadget: 'SPEC-IO Electro-Sensor', gadget_desc: 'The truth comes to light with Solis\' SPEC-IO Electro-Sensor, a new gadget detection device for Defense operatives. With the ability to mark and ping opponents\' electronic devices, there is nowhere to hide.', gadget_zh: null, gadget_zh_desc: '可用于探测敌方电子设备，然后扫描并标记其位置。', gadget_stats: ['扫描距离：20米', '最长持续时间：15s', '最长充能时间：15s', '超频次数：1+2次', '超频的充能时间：25秒/次', '关闭冷却：0.4s', '按下即可激活，再次按下即可停用。', '按住可以进行超频。'], weapons: ['ITA12L', 'P90', 'SMG-11'] },
    { name: 'Striker', side: 'atk', icon: 'striker.svg', portrait: 'images/operators/striker.webp', gadgetIcon: null, gadgetIconName: null, armor: '2', speed: 'medium', difficulty: 'easy', function: ['Support'], realname: null, birthplace: null, birthdate: null, affiliation: null, country: [], releasedate: '2024-06-11', gadget: null, gadget_desc: null, gadget_zh: '装备包', gadget_zh_desc: '===操作方法===', gadget_stats: ['Striker和Sentry固定为二甲二速，且拥有相同的技能：装备包。', '装备包可以让Striker和Sentry同时选择两种对应阵营的次要装备，但同一件装备不可以选择两次。', '主要装备破片手榴弹、烟雾弹或是电磁脉冲式冲击弹需要按下掷出，而贴片炸药需要在软墙前按下掏出来再按下（进阶部署为按住）部署', '次要装备闪光弹按下掷出，而阔剑地雷与硬突破炸药需要分别在足够的地面空间上与软墙/加固墙前前按下掏出来再按下（进阶部署为按住）', '主要装备冲击手榴弹，遥控炸药与感应警报器需要按下掷出。', '次要装备防弹摄像头可以在任意平整的表面按住进行部署（包括墙面，木板与地面），而倒刺铁丝网与机动护盾只能按住部署在地面上。', '*需要注意的是，机动护盾对地面空间的要求相对于铁丝网来说较大，且机动护盾即使拿在手里也具备防弹的功能，与其有相同功能的的还有的。'], weapons: ['5.7 USG', 'ITA12S', 'M249', 'M4', 'SR-25'] },
    { name: 'Tachanka', side: 'def', icon: 'tachanka.svg', portrait: 'images/operators/tachanka.webp', gadgetIcon: 'images/gadgets/tachanka.webp', gadgetIconName: 'Tachanka Shumikha Launcher black', armor: '3', speed: 'slow', difficulty: 'easy', function: ['Anti-Entry', 'Crowd Control'], realname: 'Alexsandr Senaviev', birthplace: 'Saint Petersburg', birthdate: '1967-11-03', affiliation: 'Spetsnaz', country: ['ru'], releasedate: '2015-12-01', gadget: 'Shumikha Launcher', gadget_desc: 'Area denial heavy incendiary grenade launcher can bounce multiple times, and their fuse timer only starts after the first bounce, giving them a lot of versatility.', gadget_zh: null, gadget_zh_desc: '燃烧榴弹发射器，所发射的重型榴弹配备定时引信，榴弹一旦接触反弹，引信就会激活。', gadget_stats: ['燃烧伤害范围：半径为2.6m的圆形区域', '伤害：12点/0.25秒', '持续时间：7秒', '反弹后引信时间：1s', '载弹量：5/15', '射速：150RPM', '初始数量为20每隔60秒额外获得5次。', '最大可携带数量：20'], weapons: ['9x19VSN', 'Bearing 9', 'DP27', 'GSH-18', 'PMM'] },
    { name: 'Thatcher', side: 'atk', icon: 'thatcher.svg', portrait: 'images/operators/thatcher.webp', gadgetIcon: 'images/gadgets/thatcher.webp', gadgetIconName: 'EG MKO-EMP Grenade', armor: '3', speed: 'slow', difficulty: 'easy', function: ['Anti-Gadget', 'Support'], realname: 'Mike Baker', birthplace: 'Bideford', birthdate: '1961-06-22', affiliation: 'S.A.S.', country: ['uk'], releasedate: '2015-12-01', gadget: 'EG MKO-EMP Grenade', gadget_desc: 'Throwable Electromagnetic Pulse grenade capable of disabling most hostile electronics within a short radius, even through walls. Disabling hostile cameras for 10 seconds instead.', gadget_zh: null, gadget_zh_desc: 'E.G.S.干扰器', gadget_stats: ['使用次数：6', '装填时间：3秒', '干扰范围：直径3.7米长度10米的圆柱', '探测范围：以仪器为球心半径10米的半球', '瘫痪时长：15秒', '按即可切换至E.G.S.干扰器。', '手持干扰器时按下即可发射电磁脉冲。', '手持干扰器时按下可产生瞄准激光。'], weapons: ['AR33', 'L85A2', 'M590A1', 'P226 MK 25', 'PMR90A2'] },
    { name: 'Thermite', side: 'atk', icon: 'thermite.svg', portrait: 'images/operators/thermite.webp', gadgetIcon: 'images/gadgets/thermite.webp', gadgetIconName: 'Brimstone BC-3', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Breach', 'Support'], realname: 'Jordan Trace', birthplace: 'Plano, Texas', birthdate: '1982-03-14', affiliation: 'SWAT', country: ['us'], releasedate: '2015-12-01', gadget: 'Brimstone BC-3 (Exo-Thermic Charge)', gadget_desc: 'Rolling mat affixed to an incendiary device that can be remotely detonated. Capable of breaching reinforced walls.', gadget_zh: '铝热炸药', gadget_zh_desc: '设置铝热炸药来破坏已被加固的墙面。', gadget_stats: ['使用次数：3', '冷却时间：无', '铝热炸药可以直接摧毁一整面加固墙，是整个游戏中破坏力最强的硬突破炸药。', '铝热炸药需要切割3秒才能引爆，切割时发出明显的声音和火光。', '铝热炸药可以部署于以下表面：（无法破坏房屋刚体承重结构）', '* 所有软墙面；', '* 所有加固表面；', '* 门和窗户的封阻物；'], weapons: ['5.7 USG', '556XI', 'ITA12S', 'M1014', 'M45 MEUSOC'] },
    { name: 'Thorn', side: 'def', icon: 'thorn.svg', portrait: 'images/operators/thorn.webp', gadgetIcon: 'images/gadgets/thorn.webp', gadgetIconName: 'Razorbloom Shell', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Anti-Entry', 'Trapper'], realname: 'Brianna Skehan', birthplace: 'County Kildare, Ireland', birthdate: '1993-06-18', affiliation: 'Garda Emergency Response Unit', country: [], releasedate: '2021-11-30', gadget: 'Razorbloom Shell', gadget_desc: 'The Razorbloom Shell sticks to a surface after it\'s thrown by Thorn. Shortly after detecting a nearby opponent, it automatically propels a set of sharp blades in all directions, delivering lethal damage.', gadget_zh: null, gadget_zh_desc: '可投掷式设备，能附着于表面，侦测发现敌人接近后，设备将快速弹出一组尖刃。', gadget_stats: ['数量：4', '部署时间：1秒', '引信时间：1.35秒', '触发半径：4米', '最大伤害：125', '伤害衰减：', '幸存者惩罚时长：10秒', '按住即可取出剃刀花榴弹以准备投掷，松开即可投出。'], weapons: ['1911 TACOPS', 'C75 Auto', 'M870', 'UZK50GI'] },
    { name: 'Thunderbird', side: 'def', icon: 'thunderbird.svg', portrait: 'images/operators/thunderbird.webp', gadgetIcon: 'images/gadgets/thunderbird.webp', gadgetIconName: 'Kona Station', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Support'], realname: 'Mina Sky', birthplace: 'Nakoda Teritories', birthdate: '1985-04-01', affiliation: 'STAR-NET Aviation', country: ['ca'], releasedate: '2021-06-14', gadget: 'Kona Station', gadget_desc: 'When deployed on the ground, the Kóna Station acts as a point of safety for injured and downed Operators. All they have to do is approach the device, and the Kóna Station automatically boosts the Operator\'s HP or offers a revive.', gadget_zh: null, gadget_zh_desc: '俗称：医疗站、奶箱', gadget_stats: ['携带数量：3个', '部署时间：3秒部署+5秒准备', '响应范围：半径为4m的球形', '治疗范围：半径为2m的球形', '治疗冷却：15s/次', '治疗量：20HP/次', '持续回复速度：3HP/秒', '初始数量为3，每隔90秒额外获得一次。'], weapons: ['Bearing 9', 'ITA12S', 'Q-929', 'SPAS-15', 'Spear .308'] },
    { name: 'Tubarão', side: 'def', icon: 'tubarao.svg', portrait: 'images/operators/tubarao.webp', gadgetIcon: 'images/gadgets/tubarao.webp', gadgetIconName: 'Zoto Canister', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Anti-Entry', 'Anti-Gadget'], realname: 'Isaac Nunes Oliviera', birthplace: 'Ponta Delgada, Azores, Portugal', birthdate: '1988-11-24', affiliation: null, country: [], releasedate: '2023-12-06', gadget: 'Zoto Canister', gadget_desc: 'Feel the chill of the new Zoto Canister. The Zoto Canister is a throwable device that can can slow enemies, freeze devices to pause their deployment and prevent use, and even leave footprints behind if the frozen area is walked on.', gadget_zh: null, gadget_zh_desc: null, gadget_stats: [], weapons: ['AR-15.50', 'MPX', 'P226 MK 25'] },
    { name: 'Twitch', side: 'atk', icon: 'twitch.svg', portrait: 'images/operators/twitch.webp', gadgetIcon: 'images/gadgets/twitch.webp', gadgetIconName: 'RSD Model 1 (Shock Drone)', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Anti-Gadget', 'Intel'], realname: 'Emmanuelle Pichon', birthplace: 'Nancy', birthdate: '1988-10-12', affiliation: 'GIGN', country: ['fr'], releasedate: '2015-12-01', gadget: 'RSD Model 1 (Shock Drone)', gadget_desc: 'Bulkier, slower and more silent than the standard observation drone, the shock drone, holds multiple shots. It\'s capable of destroying electronic equipment as well as most electronic gadgets. It can also deal small amounts of damage to players.', gadget_zh: '电击无人机', gadget_zh_desc: '无人机，可以手动操作发射激光，摧毁敌方装备。', gadget_stats: ['数量：2台', '电击弹药：1+2（备弹可以进行充能）', '充能速度：28秒/发', '伤害：5HP/发', '射击速度：2秒/发', 'Twitch依然配备2台普通的抛投式侦察无人机。', '电击无人机移动时会发出与抛投式无人侦察机完全不同的声音，且几乎无声。', '激光可无限使用，但需要时间充能。'], weapons: ['417', 'F2', 'LFP586', 'P9', 'SG-CQB'] },
    { name: 'Valkyrie', side: 'def', icon: 'valkyrie.svg', portrait: 'images/operators/valkyrie.webp', gadgetIcon: 'images/gadgets/valkyrie.webp', gadgetIconName: 'Gyro Cam MK2', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Intel', 'Support'], realname: 'Meghan J. Castellano', birthplace: 'Oceanside', birthdate: '1986-07-21', affiliation: 'NAVY SEAL', country: ['us'], releasedate: '2016-05-10', gadget: 'Gyro Cam MK2', gadget_desc: 'Encased in a tinted silicone ball, coated in micro-suction cups, the MK2 maintains a clear view thanks to the internal gyroscope that dictates the angle of the lens. The suction cups allow the camera to adhere to any surface, while the gyroscope mounted lens stabilises the camera angle and focus. The live video feed is available to all operators.', gadget_zh: null, gadget_zh_desc: '可以安放多个黑眼摄像头，为团队成员提供监控工具。', gadget_stats: ['数量:3', '初始数量为2，每隔90秒额外获得一次。', '最大可携带数量：2', '最大可部署数量：2', '单击来投掷。按住则可以瞄准投掷方向，', '在已经部署的黑眼旁边对准它按住即可回收。', '部署时为抛物线投掷，命中物体表面后附着。可附着在绝大部分物体表面；', '当黑眼附着时，会发出标志性安装声：文件:valk_skill_sound_1.flac'], weapons: ['D-50', 'MPX', 'SPAS-12'] },
    { name: 'Vigil', side: 'def', icon: 'vigil.svg', portrait: 'images/operators/vigil.webp', gadgetIcon: 'images/gadgets/vigil.webp', gadgetIconName: 'ERC-7', armor: '1', speed: 'fast', difficulty: 'hard', function: ['Anti-Gadget', 'Crowd Control'], realname: 'Chul Kyung Hwa', birthplace: null, birthdate: '1984-1-17', affiliation: '707th SMB', country: ['kr'], releasedate: '2017-12-05', gadget: 'ERC-7 (Electronic Rendering Cloak)', gadget_desc: 'Chul Kyung’s quiet lethality in the field allows him to rely on his Electronic Rendering Cloak (ERC-7) to remain undetected. The ERC-7 uses Diminished Reality technology to remove perceivable stimuli from its direct environment. Vigil carries a prototype in his backpack, which scans surrounding electronic devices and wipes his image from any cameras in view.', gadget_zh: null, gadget_zh_desc: 'Vigil在战场上来无影去无踪的能力仰赖于他的电子渲染迷彩（ERC-7）。ERC-7使用削弱实境技术，能移除直接环境的感知刺激。Vigil将原型机放入其后背包，可以扫描周遭的电子装置，并从任何监视器上消除他的踪迹。', gadget_stats: ['使用次数：无限制', '最大使用时间：15秒', '最大充能时间：15秒', '关闭冷却：0.8秒', '无变化', '激活时，Vigil将在所有进攻方的情报设施视野中隐形，包括被侵入的防守方观测工具、的和夺取的防守方观测工具。', '当运作时，Vigil开启技能并移动，或开启技能走入的范围，都会暴露Vigil的身份，但只要Vigil不关闭技能，就不会被持续标记。', '激活期间不会被所夺取的所标记。'], weapons: ['BOSG.12.2', 'C75 Auto', 'K1A', 'SMG-12'] },
    { name: 'Wamai', side: 'def', icon: 'wamai.svg', portrait: 'images/operators/wamai.webp', gadgetIcon: 'images/gadgets/wamai.webp', gadgetIconName: 'Wamai Mag-NET', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Anti-Gadget', 'Trapper'], realname: 'Ngũgĩ Muchoki Furaha', birthplace: 'Lamu', birthdate: '1991-06-01', affiliation: 'NIGHTHAVEN', country: [], releasedate: '2019-12-03', gadget: 'Mag-NET', gadget_desc: 'The Mag-NET System is a thrown, adhesive gadget. It sticks to surfaces and waits. Its function is to attract an opponent’s projectile to its position, and then self-destruct to detonate that projectile. This way, not only can Wamai make Attackers’ grenades and projectile gadgets useless, he can also use strategic placement to turn those projectiles against them.', gadget_zh: '摧毁', gadget_zh_desc: '俗称：磁网、飞盘、飞饼', gadget_stats: ['道具数量：1+6个', '生成所需时间：20秒/个', '作用范围：3.5米', '按住能够将磁力销毁装置拿在手中', '对准目标并松开即可投出', '游戏开局时Wamai即拥有1个磁力销毁装置，每过20秒都会生成一个，最多拥有合计7个，之后不再生成。', '扔出后需要0.5秒完成部署，作用范围为3.5米。', '磁力销毁装置会将投掷物吸引至其所在位置，除极个别道具会被摧毁之外，其他的都会在装置所在位置触发。'], weapons: ['AUG A2', 'Keratos .357', 'MP5K', 'P12', 'Super Shorty'] },
    { name: 'Warden', side: 'def', icon: 'warden.svg', portrait: 'images/operators/warden.webp', gadgetIcon: 'images/gadgets/warden.webp', gadgetIconName: 'Glance Smart Glasses', armor: '3', speed: 'slow', difficulty: 'normal', function: ['Anti-Gadget', 'Intel'], realname: 'Collinn McKinley', birthplace: 'Louisville', birthdate: '1971-03-18', affiliation: 'Secret Service', country: ['us'], releasedate: '2019-06-11', gadget: 'Glance Smart Glasses', gadget_desc: 'Eyewear that improves visibility in smoke while standing still. Can also be activated to protect against or reduce flash blindness.', gadget_zh: null, gadget_zh_desc: '俗称：眼镜、透烟镜、防闪镜', gadget_stats: ['使用次数：无限制', '最大使用时间：22秒（从屏幕变为蓝色开始算起）', '最大充能时间：22秒', '关闭冷却：1.6秒', '技能主动开关硬直：0.5秒', '玩家只需单击，即可施放技能，中途可以再次按下关闭。', '施放技能时Warden会亮出腕表、当游戏画面视觉显示淡蓝色眼镜特效并听到效果音后表示技能已在启用中。', '启动技能能够立即解除已经受到的闪光致盲效果。技能启用中可以免疫期间受到的任何闪光致盲效果。可应对的闪光具体包括：'], weapons: ['M590A1', 'MPX', 'P-10C', 'SMG-12'] },
    { name: 'Ying', side: 'atk', icon: 'ying.svg', portrait: 'images/operators/ying.webp', gadgetIcon: 'images/gadgets/ying.webp', gadgetIconName: 'Candela Device', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Front Line', 'Map Control'], realname: 'Siu Mei Lin', birthplace: 'Hong Kong', birthdate: '1983-5-12', affiliation: 'S.D.U.', country: ['hk'], releasedate: '2017-09-05', gadget: 'Candela Device', gadget_desc: 'Inspired by the new breed of stun grenades showcased by the S.A.S., this mercury and magnesium based explosive creates a multitude of blinding flashes. The Candela device releases a cluster of flash charges that can either be anchored on surfaces or thrown out as a grenade.', gadget_zh: null, gadget_zh_desc: '可以嵌入表面或以榴弹形式发射的破片闪光弹。', gadget_stats: ['携带数量：4颗', '爆闪次数：7/每颗', '致盲时间：1.6秒/每颗', '安装于平面并触发所需时间：1.33秒。', '初始数量为2，每隔45秒额外获得一次。', '最大可携带数量：2', '按住能够握持烛光装置并储备阶段层数，松开即可投出或安装在平面上。', '单击可以不进行握持，直接投出或安装。'], weapons: ['Q-929', 'Reaper MK2', 'SIX12', 'T-95 LSW'] },
    { name: 'Zero', side: 'atk', icon: 'zero.svg', portrait: 'images/operators/zero.webp', gadgetIcon: 'images/gadgets/zero.webp', gadgetIconName: 'Zero Argus Launcher', armor: '1', speed: 'fast', difficulty: 'easy', function: ['Anti-Gadget', 'Intel'], realname: 'Samuel Leo Fisher', birthplace: 'Baltimore', birthdate: '1957-8-8', affiliation: 'ROS', country: [], releasedate: '2020-09-10', gadget: 'Argus Launcher', gadget_desc: 'Intel is crucial to a good attack strategy, and Zero is well aware of that. His Argus Launcher is equipped with very special cameras that can lodge themselves into breakable and reinforced surface to surveil either side.', gadget_zh: null, gadget_zh_desc: '俗称：百眼、鱼眼、针眼', gadget_stats: ['数量：6', '激光充能上限：1发', '激光充能速度：12秒/发', '激光伤害：5hp/发', '初始数量为2，每隔90秒额外获得一次。', '最大可携带数量：2', '最大可部署数量：2', '按下拿出发射器，与普通枪械操作完全相同。'], weapons: ['5.7 USG', 'GONNE-6', 'MP7', 'SC3000K'] },
    { name: 'Zofia', side: 'atk', icon: 'zofia.svg', portrait: 'images/operators/zofia.webp', gadgetIcon: 'images/gadgets/zofia.webp', gadgetIconName: 'KS79 Lifeline', armor: '3', speed: 'slow', difficulty: 'easy', function: ['Anti-Gadget', 'Breach'], realname: 'Zofia Bosak', birthplace: 'Wrocław', birthdate: '1981-1-28', affiliation: 'GROM', country: ['pl'], releasedate: null, gadget: 'Withstand(Removed)', gadget_desc: 'Zofia\'s special ability to withstand allows her to revive herself for a 95% health penalty after entering the down but not out (DBNO) state. After Year 5 Season 4 patch 5.4.3, this ability has been removed from the game.', gadget_zh: null, gadget_zh_desc: 'KS79双管发射器采用电子抛射技术，可以射击震撼与冲击弹药。共有四发弹药：', gadget_stats: ['冲击弹', '*数量：3发', '*伤害：60', '*爆炸范围：直径2米', '震撼弹', '*数量：3发', '*眩晕范围：半径4米', '*眩晕持续时间：7秒'], weapons: ['LMG-E', 'M762', 'RG15'] },
];
