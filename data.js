...
const OPERATORS = [
    ...
    { name: 'Aruni', side: 'def', icon: 'aruni.svg', portrait: 'images/operators/aruni.webp', gadgetIcon: 'images/gadgets/aruni.webp', gadgetIconName: 'Aruni Surya Gate', armor: '3', speed: 'slow', difficulty: 'normal', function: ['Anti-Entry', 'Anti-Gadget'], realname: 'Apha Tawanroong', birthplace: 'Ta Phraya District', birthdate: '1978-08-09', affiliation: null, country: [], releasedate: '2020-12-01', gadget: 'Prosthetic Arm', gadget_desc: 'Melee punch with destructive capabilities.', gadget_zh: null, gadget_zh_desc: '可固定在墙体或攻入点上的激光发射装置，在对装备或敌人造成伤害后会停用，可以重新启用', gadget_stats: ['持有数量：3', '对干员伤害：30HP/次', '过载后冷却时间：30s', '重启次数限制：无限次', '对着可部署的表面长按施放。', '在激光门本体附近面朝本体，长按可以收回技能道具。', '将视角对准门、窗、活板门和可完全破坏的墙面部署激光门发生器，之后在部署位置生成激光门。', '炎阳激光门生成在门上的时候，会和封阻物一样，下方会留有供侦察无人机穿行的缝隙。'], weapons: ['Mk 14 EBR', 'P10 RONI', 'PRB92'] },
    ...
    { name: 'Osa', side: 'atk', icon: 'osa.svg', portrait: 'images/operators/osa.webp', gadgetIcon: 'images/gadgets/osa.webp', gadgetIconName: 'Talon-8 Clear Shield', armor: '3', speed: 'slow', difficulty: 'normal', function: ['Intel', 'Support'], realname: 'Anja Katarina Janković', birthplace: 'Split, Croatia', birthdate: '1994-04-29', affiliation: null, country: [], releasedate: '2021-09-07', gadget: 'Talon-8 Clear Shield', gadget_desc: 'The transparent and bulletproof Talon-8 Shield can be carried by Osa or deployed on floors or window frames, giving her a protective line of sight while she formulates an attack strategy.', gadget_zh: null, gadget_zh_desc: '透明防弹护盾，可手持或部署在地板和窗框上。', gadget_stats: ['数量：2', '部署时间：1.8秒', '按下拿出护盾。', '按住部署护盾。', '对已部署且未破碎的护盾，按住回收。', '透明护盾可以完全抵挡子弹与激光伤害。', '当Osa手持透明护盾时：', '* 站立会露出腿部，蹲下可保护全身，但移动时会露出脚；'], weapons: ['556XI', 'PDW9', 'PMM'] },
