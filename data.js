...
const OPERATORS = [
    ...
    { name: 'Mira', side: 'def', icon: 'mira.svg', armor: '3', speed: 'slow', difficulty: 'hard', function: ['Intel', 'Support'], realname: 'Elena María Álvarez', birthplace: 'Madrid', birthdate: '1977-11-18', affiliation: 'G.E.O.', country: ['es'], releasedate: '2017-02-07', gadget: 'Black Mirror', gadget_desc: 'A one-way bulletproof mirror placeable on breakable and reinforcable walls. The window can also be ejected to create a murder hole.', gadget_zh: null, gadget_zh_desc: null, gadget_stats: [], weapons: ['ITA12L', 'ITA12S', 'USP40', 'Vector .45'] },
    ...
    { name: 'Pulse', side: 'def', icon: 'pulse.svg', armor: '1', speed: 'fast', difficulty: 'hard', function: ['Intel', 'Support'], realname: 'Jack Estrada', birthplace: 'Goldsboro, North Carolina', birthdate: '1984-10-11', affiliation: 'SWAT', country: ['us'], releasedate: '2015-12-01', gadget: 'HB-5 Cardiac Sensor', gadget_desc: 'This heartbeat detector can read thermal signatures through walls and other obstacles.', gadget_zh: null, gadget_zh_desc: null, gadget_stats: [], weapons: ['5.7 USG', 'M1014', 'M45 MEUSOC', 'Reaper MK2', 'UMP45'] },
    { name: 'Ram', side: 'atk', icon: 'ram.svg', armor: '3', speed: 'slow', difficulty: 'normal', function: ['Breach', 'Anti-Gadget'], realname: 'Bo-Ram Choi', birthplace: 'Busan, South Korea', birthdate: '1986-04-25', affiliation: null, country: [], releasedate: '2023-08-29', gadget: 'BU-GI Auto Breacher', gadget_desc: 'Very little can stand in the way of the new BU-GI Auto Breacher. This deployable mini-tank destroys all breakable surfaces and devices in its way along a set path, leaving a trail of destruction in its wake.', gadget_zh: null, gadget_zh_desc: null, gadget_stats: [], weapons: ['LMG-E', 'Mk1 9mm', 'R4-C'] },
    { name: 'Rauora', side: 'atk', icon: 'rauora.svg', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Support', 'Map Control'], realname: 'Hāpai Iwini', birthplace: 'Christchurch, New Zealand', birthdate: '1996-05-11', affiliation: null, country: [], releasedate: '2025-03-04', gadget: 'D.O.M. Panel Launcher', gadget_desc: 'Seize control over the map with Rauora’s D.O.M. Panel Launcher. Deploy bulletproof panels from a distance and strategically control the flow of combat. With a quick trigger at the top of the door, open or close the panel to create tactical opportunities.', gadget_zh: null, gadget_zh_desc: null, gadget_stats: [], weapons: ['417', 'GSH-18', 'M249', 'Reaper MK2', 'XK23'] },
    { name: 'Rook', side: 'def', icon: 'rook.svg', armor: '3', speed: 'slow', difficulty: 'easy', function: ['Support'], realname: 'Julien Nizan', birthplace: 'Tours', birthdate: '1990-01-06', affiliation: 'GIGN', country: ['fr'], releasedate: '2015-12-01', gadget: 'R1N "Rhino" Armor', gadget_desc: 'A multi-hit boron ceramic plate with a special spall-stop coating, and a back-face deformation (BFD) plate stored in a light weight sturdy satchel for rapid field deployment.', gadget_zh: null, gadget_zh_desc: null, gadget_stats: [], weapons: ['LFP586', 'MP5', 'P9', 'P90', 'Reaper MK2', 'SG-CQB'] },
    { name: 'Sens', side: 'atk', icon: 'sens.svg', armor: '1', speed: 'fast', difficulty: 'normal', function: ['Support', 'Map Control'], realname: 'Néon Ngoma Mutombo', birthplace: 'Brussels, Belgium', birthdate: '1992-03-03', affiliation: 'Belgian Special Forces Group (B-SFG)', country: [], releasedate: '2022-06-14', gadget: 'R.O.U. Projector System', gadget_desc: 'R.O.U. Projector System rolls after it\'s thrown by Sens and drops small projectors to create a screen along its path. Although physical objects can still pass through the screen, it\'s highly flexible—cutting off multiple lines of sight at once.', gadget_zh: null, gadget_zh_desc: null, gadget_stats: [], weapons: ['417', 'GONNE-6', 'POF-9', 'SDP 9mm', 'XK23'] },
    { name: 'Sentry', side: 'def', icon: 'sentry.svg', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Support'], realname: null, birthplace: null, birthdate: null, affiliation: null, country: [], releasedate: '2024-06-11', gadget: null, gadget_desc: null, gadget_zh: null, gadget_zh_desc: null, gadget_stats: [], weapons: ['C75 Auto', 'Commando 9', 'M870', 'Super Shorty', 'TCSG12'] },
    { name: 'Skopos', side: 'def', icon: 'skopos.svg', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Intel', 'Support'], realname: 'Kure Galanos', birthplace: 'Nicosia, Cyprus', birthdate: '1982-07-25', affiliation: 'Hellenic Armed Forces', country: ['gr'], releasedate: '2024-09-10', gadget: 'V10 Pantheon Shells', gadget_desc: 'With a pair of V10 Pantheon Shells, Skopós enters the battlefield in control of one as an Operator and the other as an Observation Tool protected by a reinforced shield. While she can only operate one at a time and will lose connection to both shells if one is destroyed, she can switch between them at will, making Skopós an effective intel and support Operator.', gadget_zh: null, gadget_zh_desc: null, gadget_stats: [], weapons: ['P229', 'PCX-33'] },
    { name: 'Sledge', side: 'atk', icon: 'sledge.svg', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Breach', 'Anti-Gadget'], realname: 'Seamus Cowden', birthplace: 'John o\'Groats', birthdate: '1982-04-02', affiliation: 'S.A.S.', country: ['uk'], releasedate: '2015-12-01', gadget: 'The Caber (Tactical Breaching Hammer)', gadget_desc: 'The Breaching Hammer is capable of making doors in destructible walls and instantly destroying barricades. Additionally, the Breaching Hammer can be used as a melee weapon and to destroy barbed wire.', gadget_zh: null, gadget_zh_desc: null, gadget_stats: [], weapons: ['L85A2', 'M590A1', 'P226 MK 25', 'Reaper MK2', 'SMG-11'] },
    { name: 'Smoke', side: 'def', icon: 'smoke.svg', armor: '2', speed: 'medium', difficulty: 'normal', function: ['Anti-Entry', 'Trapper'], realname: 'James Porter', birthplace: 'London', birthdate: '1981-05-14', affiliation: 'S.A.S.', country: ['uk'], releasedate: '2015-12-01', gadget: 'Compound Z8 (Remote Gas Grenade)', gadget_desc: 'Throwable canister containing a toxic gas. Sticks to any surface and can be remotely detonated at will.', gadget_zh: null, gadget_zh_desc: null, gadget_stats: [], weapons: ['FMG-9', 'M590A1', 'P226 MK 25', 'SMG-11'] },
    { name: 'Solid Snake', side: 'atk', icon: null, armor: '1', speed: 'fast', difficulty: 'normal', function: ['Intel', 'Front Line'], realname: 'David', birthplace: 'United States', birthdate: '\'\'Redacted\'\'', affiliation: null, country: [], releasedate: '2026-03-03', gadget: 'Soliton Radar Mk. III', gadget_desc: 'Find nearby enemy threats with Solid Snake\'s Soliton Radar Mk. III, a handheld device with a minimap that marks any hostiles present. Use the device\'s precision mode to pinpoint threats, but be wary, as this will alert enemies that they\'ve been detected by Solid Snake. The Radar provides a view of immediate surroundings, making it an excellent tool for recon that allows allies to lay groundwork and take map control quickly. While hunting down enemies, Solid Snake can also scavenge gadgets from fallen Operators to adapt to the ever-changing needs of the battle.', gadget_zh: null, gadget_zh_desc: null, gadget_stats: [], weapons: ['F2', 'PMR90A2', 'TACIT .45'] },
    { name: 'Solis', side: 'def', icon: 'solis.svg', armor: '2', speed: 'medium', difficulty: 'hard', function: ['Intel', 'Support'], realname: 'Ana Valentina Díaz', birthplace: 'Zipaquirá, Colombia', birthdate: '1985-09-18', affiliation: 'AFEAU', country: [], releasedate: '2022-11-21', gadget: 'SPEC-IO Electro-Sensor', gadget_desc: 'The truth comes to light with Solis\' SPEC-IO Electro-Sensor, a new gadget detection device for Defense operatives. With the ability to mark and ping opponents\' electronic devices, there is nowhere to hide.', gadget_zh: null, gadget_zh_desc: null, gadget_stats: [], weapons: ['ITA12L', 'P90', 'SMG-11'] },
    { name: 'Striker', side: 'atk', icon: 'striker.svg', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Support'], realname: null, birthplace: null, birthdate: null, affiliation: null, country: [], releasedate: '2024-06-11', gadget: null, gadget_desc: null, gadget_zh: null, gadget_zh_desc: null, gadget_stats: [], weapons: ['5.7 USG', 'ITA12S', 'M249', 'M4', 'SR-25'] },
