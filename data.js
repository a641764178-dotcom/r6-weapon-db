...
const OPERATORS = [
    ...
    { name: 'Blitz', side: 'atk', icon: 'blitz.svg', armor: '2', speed: 'medium', difficulty: 'hard', function: ['Front Line', 'Map Control'], realname: 'Elias Kötz', birthplace: 'Bremen', birthdate: '1980-04-02', affiliation: 'GSG 9', country: ['de'], releasedate: '2015-12-01', gadget: 'G52-Tactical Shield', gadget_desc: 'Ballistic shield light enough to permit its wielder to sprint, it comes equipped with 24 flash-bang grenades spread over 3 rows providing a high intensity light source when triggered.', gadget_zh: null, gadget_zh_desc: '启用装配在防弹盾牌上的高亮闪光灯来暂时让敌人眩盲。', gadget_stats: ['使用次数：4', '冷却时间：7秒', '致盲范围：5米', '单击使用闪光灯；', '游戏开始时默认手持闪光护盾，按下或滚动可以在手持和把闪光护盾背在身后之间切换；', '护盾背在身后时单击会切换至手持并使用闪光灯。', '闪光灯可对前方水平角度至少60度，距离2个身位内的敌人产生作用。', '闪光灯效果不同于闪光弹，可以致盲但不会使目标失去听觉。'], weapons: ['P12'] },
    ...
    { name: 'Ram', side: 'atk', icon: 'ram.svg', armor: '3', speed: 'slow', difficulty: 'normal', function: ['Breach', 'Anti-Gadget'], realname: 'Bo-Ram Choi', birthplace: 'Busan, South Korea', birthdate: '1986-04-25', affiliation: null, country: [], releasedate: '2023-08-29', gadget: 'BU-GI Auto Breacher', gadget_desc: 'Very little can stand in the way of the new BU-GI Auto Breacher. This deployable mini-tank destroys all breakable surfaces and devices in its way along a set path, leaving a trail of destruction in its wake.', gadget_zh: '隔墙', gadget_zh_desc: '“龟甲”自动突破设备|缩略图|260px', gadget_stats: ['持有数量：3辆', '启动后持续：10秒', '直行速度：1米/秒', '行进方向：直行/左前/右前', '设备伤害：5点/0.5秒', '“龟甲”突破车体积较大且重量较重，所以无法抛至较远距离，也无法通过小车洞。车辆抛出后只有落到平面才能启用。', '突破车除尾部的红色压缩气罐外的所有部位均可防御射击以及近战攻击。', '突破车免疫电流，其无法被与的电流破坏。'], weapons: ['LMG-E', 'Mk1 9mm', 'R4-C'] },
    ...
    { name: 'Sentry', side: 'def', icon: 'sentry.svg', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Support'], realname: null, birthplace: null, birthdate: null, affiliation: null, country: [], releasedate: '2024-06-11', gadget: null, gadget_desc: null, gadget_zh: '装备包', gadget_zh_desc: '===操作方法===', gadget_stats: ['Striker和Sentry的属性都为二甲二速，且拥有相同的技能：装备包。', '装备包可以让Striker和Sentry同时选择两种对应阵营的次要装备，但同一件装备不可以选择两次。', '主要装备破片手榴弹、烟雾弹或是电磁脉冲式冲击弹需要按下掷出，而贴片炸药需要在软墙前按下掏出来再按下（进阶部署为按住）部署', '次要装备闪光弹按下掷出，而阔剑地雷与硬突破炸药需要分别在足够的地面空间上与软墙/加固墙前前按下掏出来再按下（进阶部署为按住）', '主要装备冲击手榴弹，遥控炸药与感应警报器需要按下掷出。', '次要装备防弹摄像头可以在任意平整的表面按住进行部署（包括墙面，木板与地面），而倒刺铁丝网与机动护盾只能按住部署在地面上。', '*需要注意的是，机动护盾对地面空间的要求相对于铁丝网来说较大，且机动护盾即使拿在手里也具备防弹的功能，与其有相同功能的的还有的。'], weapons: ['C75 Auto', 'Commando 9', 'M870', 'Super Shorty', 'TCSG12'] },
    ...
    { name: 'Sledge', side: 'atk', icon: 'sledge.svg', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Breach', 'Anti-Gadget'], realname: 'Seamus Cowden', birthplace: 'John o\'Groats', birthdate: '1982-04-02', affiliation: 'S.A.S.', country: ['uk'], releasedate: '2015-12-01', gadget: 'The Caber (Tactical Breaching Hammer)', gadget_desc: 'The Breaching Hammer is capable of making doors in destructible walls and instantly destroying barricades. Additionally, the Breaching Hammer can be used as a melee weapon and to destroy barbed wire.', gadget_zh: null, gadget_zh_desc: '使用战术突破锤来突破可以破坏的表面。', gadget_stats: ['使用次数：25', '冷却时间：无', '具有涵盖并高于近战攻击的基础属性，包括对干员具有一击必杀的特性。攻击距离比近战攻击稍远，但攻击前摇时间较长。', '使用战术突破锤锤击门窗封阻板、未加固的活板门可一击将其完全破坏。', '战术突破锤能在软平面上制造一个约为2.5米的矩形洞口。', '对软墙面进行破坏后会出现一个形状为矩形且可供人通行的洞。', '对地板或者天花板，以及某些软墙面，破坏后会显现出房屋的金属承重结构。只能用于交火，不可供人通过。', '战术突破锤可以更高效地摧毁一些无法用枪械或近战攻击直接摧毁的装备，包括但不限于：'], weapons: ['L85A2', 'M590A1', 'P226 MK 25', 'Reaper MK2', 'SMG-11'] },
    ...
    { name: 'Solis', side: 'def', icon: 'solis.svg', armor: '2', speed: 'medium', difficulty: 'hard', function: ['Intel', 'Support'], realname: 'Ana Valentina Díaz', birthplace: 'Zipaquirá, Colombia', birthdate: '1985-09-18', affiliation: 'AFEAU', country: [], releasedate: '2022-11-21', gadget: 'SPEC-IO Electro-Sensor', gadget_desc: 'The truth comes to light with Solis\' SPEC-IO Electro-Sensor, a new gadget detection device for Defense operatives. With the ability to mark and ping opponents\' electronic devices, there is nowhere to hide.', gadget_zh: null, gadget_zh_desc: '可用于探测敌方电子设备，然后扫描并标记其位置。', gadget_stats: ['扫描距离：20米', '最长持续时间：15s', '最长充能时间：15s', '超频次数：1+2次', '超频的充能时间：25秒/次', '关闭冷却：0.4s', '按下即可激活，再次按下即可停用。', '按住可以进行超频。'], weapons: ['ITA12L', 'P90', 'SMG-11'] },
    { name: 'Striker', side: 'atk', icon: 'striker.svg', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Support'], realname: null, birthplace: null, birthdate: null, affiliation: null, country: [], releasedate: '2024-06-11', gadget: null, gadget_desc: null, gadget_zh: '装备包', gadget_zh_desc: '===操作方法===', gadget_stats: ['Striker和Sentry固定为二甲二速，且拥有相同的技能：装备包。', '装备包可以让Striker和Sentry同时选择两种对应阵营的次要装备，但同一件装备不可以选择两次。', '主要装备破片手榴弹、烟雾弹或是电磁脉冲式冲击弹需要按下掷出，而贴片炸药需要在软墙前按下掏出来再按下（进阶部署为按住）部署', '次要装备闪光弹按下掷出，而阔剑地雷与硬突破炸药需要分别在足够的地面空间上与软墙/加固墙前前按下掏出来再按下（进阶部署为按住）', '主要装备冲击手榴弹，遥控炸药与感应警报器需要按下掷出。', '次要装备防弹摄像头可以在任意平整的表面按住进行部署（包括墙面，木板与地面），而倒刺铁丝网与机动护盾只能按住部署在地面上。', '*需要注意的是，机动护盾对地面空间的要求相对于铁丝网来说较大，且机动护盾即使拿在手里也具备防弹的功能，与其有相同功能的的还有的。'], weapons: ['5.7 USG', 'ITA12S', 'M249', 'M4', 'SR-25'] },
    ...
    { name: 'Thorn', side: 'def', icon: 'thorn.svg', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Anti-Entry', 'Trapper'], realname: 'Brianna Skehan', birthplace: 'County Kildare, Ireland', birthdate: '1993-06-18', affiliation: 'Garda Emergency Response Unit', country: [], releasedate: '2021-11-30', gadget: 'Razorbloom Shell', gadget_desc: 'The Razorbloom Shell sticks to a surface after it\'s thrown by Thorn. Shortly after detecting a nearby opponent, it automatically propels a set of sharp blades in all directions, delivering lethal damage.', gadget_zh: null, gadget_zh_desc: '可投掷式设备，能附着于表面，侦测发现敌人接近后，设备将快速弹出一组尖刃。', gadget_stats: ['数量：4', '部署时间：1秒', '引信时间：1.35秒', '触发半径：4米', '最大伤害：125', '伤害衰减：', '幸存者惩罚时长：10秒', '按住即可取出剃刀花榴弹以准备投掷，松开即可投出。'], weapons: ['1911 TACOPS', 'C75 Auto', 'M870', 'UZK50GI'] },
    { name: 'Thunderbird', side: 'def', icon: 'thunderbird.svg', armor: '2', speed: 'medium', difficulty: 'easy', function: ['Support'], realname: 'Mina Sky', birthplace: 'Nakoda Teritories', birthdate: '1985-04-01', affiliation: 'STAR-NET Aviation', country: ['ca'], releasedate: '2021-06-14', gadget: 'Kona Station', gadget_desc: 'When deployed on the ground, the Kóna Station acts as a point of safety for injured and downed Operators. All they have to do is approach the device, and the Kóna Station automatically boosts the Operator\'s HP or offers a revive.', gadget_zh: null, gadget_zh_desc: '俗称：医疗站、奶箱', gadget_stats: ['携带数量：3个', '部署时间：3秒部署+5秒准备', '响应范围：半径为4m的球形', '治疗范围：半径为2m的球形', '治疗冷却：15s/次', '治疗量：20HP/次', '持续回复速度：3HP/秒', '初始数量为3，每隔90秒额外获得一次。'], weapons: ['Bearing 9', 'ITA12S', 'Q-929', 'SPAS-15', 'Spear .308'] },
